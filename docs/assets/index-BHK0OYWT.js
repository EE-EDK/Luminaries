...
`].filter(oo).join(`
`)),r=il(r),r=lu(r,e),r=hu(r,e),a=il(a),a=lu(a,e),a=hu(a,e),r=uu(r),a=uu(a),e.isRawShaderMaterial!==!0&&(y=`#version 300 es
...
`)+`
`+d);const v=y+p+r,x=y+d+a,E=ru(i,i.VERTEX_SHADER,v),T=ru(i,i.FRAGMENT_SHADER,x);i.attachShader(_,E),i.attachShader(_,T),e.index0AttributeName!==void 0?i.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function b(P){if(s.debug.checkShaderErrors){const F=i.getProgramInfoLog(_).trim(),U=i.getShaderInfoLog(E).trim(),z=i.getShaderInfoLog(T).trim();let V=!0,H=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(V=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,_,E,T);else{const $=cu(i,E,"vertex"),q=cu(i,T,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}Ns.BlurDirectionX=new ht(1,0);Ns.BlurDirectionY=new ht(0,1);let Xi=null,Yl=!0;try{const s=new Sv(vt,Ke),t=new Ns(new ht(window.innerWidth,window.innerHeight),.6,.4,.85);Xi=new wv(Ge),Xi.addPass(s),Xi.addPass(t)}catch(s){console.warn("Bloom unavailable, falling back to direct render:",s.message),Yl=!1}window.addEventListener("resize",()=>{Yl&&Xi&&Xi.setSize(window.innerWidth,window.innerHeight)});function yu(){Yl&&Xi?Xi.render():Ge.render(vt,Ke)}const ql=new s0(G.ambient,G.ground,.5);vt.add(ql);const Tn=new na(G.moon,.85);Tn.position.set(30,60,-20);Tn.castShadow=!0;Tn.shadow.camera.left=-90;Tn.shadow.camera.right=90;Tn.shadow.camera.top=90;Tn.shadow.camera.bottom=-90;Tn.shadow.camera.near=1;Tn.shadow.camera.far=250;Tn.shadow.mapSize.set(1024,1024);Tn.shadow.bias=-.001;vt.add(Tn);const An=new na(2241365,.3);An.position.set(-40,45,25);An.castShadow=!0;An.shadow.camera.left=-70;An.shadow.camera.right=70;An.shadow.camera.top=70;An.shadow.camera.bottom=-70;An.shadow.camera.near=1;An.shadow.camera.far=200;An.shadow.mapSize.set(512,512);An.shadow.bias=-.002;vt.add(An);const Rf=new na(3359829,.4);Rf.position.set(-25,15,30);vt.add(Rf);const Pf=new ji(3368516,.7,100);Pf.position.set(0,.5,0);vt.add(Pf);const Ev=[{pos:[15,3,15],col:3368618,int:.8,dist:30},{pos:[-20,4,-10],col:6702216,int:.7,dist:25},{pos:[0,5,30],col:2263142,int:.7,dist:28},{pos:[-15,3,20],col:4491417,int:.6,dist:22},{pos:[25,3,-20],col:10053188,int:.5,dist:20}];for(const s of Ev){const t=new ji(s.col,s.int,s.dist);t.position.set(s.pos[0],s.pos[1],s.pos[2]),vt.add(t)}const If=new na(4478327,.4);If.position.set(-10,25,40);vt.add(If);const Zl=new ji(6719624,.6,20);vt.add(Zl);const Ui=[];function Tv(){for(let s=0;s<pv;s++){const t=new ji(G.crystal,0,16);vt.add(t),Ui.push(t)}}const ro=new ji(G.orbGold,0,15);vt.add(ro);const Ce={};let Eo=0,Yi=0,oa=!1,Lf=!1,$l=0,Kl=0,Jl=!1,ra=!1,Do=!1,Gr=null,$i=null,rl=0,al=0,cl=null;function Av(s){cl=s}function Cv(s){Lf=s}function Rv(s){ra=s}function Uo(){!Lf&&cl&&cl()}window.addEventListener("keydown",s=>{Ce[s.code]=!0,"Space ShiftLeft ShiftRight KeyW KeyA KeyS KeyD".split(" ").indexOf(s.code)>=0&&s.preventDefault(),Uo()});window.addEventListener("keyup",s=>{Ce[s.code]=!1});window.addEventListener("blur",()=>{for(const s in Ce)Ce[s]=!1;oa=!1});Ge.domElement.addEventListener("mousedown",()=>{oa=!0,Uo()});window.addEventListener("mouseup",()=>{oa=!1});window.addEventListener("mousemove",s=>{oa&&(Eo-=s.movementX*kr,Yi-=s.movementY*kr,Yi=Math.max(-1,Math.min(1,Yi)))});const Pv="ontouchstart"in window||navigator.maxTouchPoints>0,No=document.getElementById("joy-zone"),Hr=document.getElementById("joy-knob"),jl=document.getElementById("btn-jump");Pv&&(No.style.display="block",jl.style.display="block",document.getElementById("controls").textContent="Stick: Move · Drag right: Look · JUMP");function Df(s,t){const e=No.getBoundingClientRect();let n=s-(e.left+e.width/2),i=t-(e.top+e.height/2);const o=Math.sqrt(n*n+i*i),r=52;o>r&&(n=n/o*r,i=i/o*r),$l=n/r,Kl=i/r,Hr.style.left=40+n+"px",Hr.style.top=40+i+"px"}No.addEventListener("touchstart",s=>{s.preventDefault(),s.stopPropagation(),Uo();const t=s.changedTouches[0];Gr=t.identifier,Jl=!0,Df(t.clientX,t.clientY)},{passive:!1});No.addEventListener("touchmove",s=>{s.preventDefault(),s.stopPropagation();for(let t=0;t<s.changedTouches.length;t++)s.changedTouches[t].identifier===Gr&&Df(s.changedTouches[t].clientX,s.changedTouches[t].clientY)},{passive:!1});No.addEventListener("touchend",s=>{s.preventDefault(),s.stopPropagation();for(let t=0;t<s.changedTouches.length;t++)s.changedTouches[t].identifier===Gr&&(Gr=null,Jl=!1,$l=0,Kl=0,Hr.style.left="40px",Hr.style.top="40px")},{passive:!1});jl.addEventListener("touchstart",s=>{s.preventDefault(),s.stopPropagation(),Uo(),ra=!0},{passive:!1});jl.addEventListener("touchend",s=>{s.preventDefault(),s.stopPropagation(),ra=!1},{passive:!1});Ge.domElement.addEventListener("touchstart",s=>{s.preventDefault(),Uo();for(let t=0;t<s.changedTouches.length;t++){const e=s.changedTouches[t];e.clientX>window.innerWidth*.3&&$i===null&&($i=e.identifier,rl=e.clientX,al=e.clientY)}},{passive:!1});Ge.domElement.addEventListener("touchmove",s=>{s.preventDefault();for(let t=0;t<s.changedTouches.length;t++){const e=s.changedTouches[t];e.identifier===$i&&(Eo-=(e.clientX-rl)*kr,Yi-=(e.clientY-al)*kr,Yi=Math.max(-1,Math.min(1,Yi)),rl=e.clientX,al=e.clientY)}},{passive:!1});Ge.domElement.addEventListener("touchend",s=>{for(let t=0;t<s.changedTouches.length;t++)s.changedTouches[t].identifier===$i&&($i=null)},{passive:!1});Ge.domElement.addEventListener("touchcancel",s=>{for(let t=0;t<s.changedTouches.length;t++)s.changedTouches[t].identifier===$i&&($i=null)},{passive:!1});function Iv(){let s=0,t=0;Ce.KeyW&&(t-=1),Ce.KeyS&&(t+=1),Ce.KeyA&&(s-=1),Ce.KeyD&&(s+=1),Jl&&(s+=$l,t+=Kl);const e=Math.sqrt(s*s+t*t);e>1&&(s/=e,t/=e);const n=Yx*(Ce.ShiftLeft||Ce.ShiftRight||Do?qx:1),i=Math.sin(Eo),o=Math.cos(Eo);return{x:(s*o+t*i)*n,z:(-s*i+t*o)*n}}const hn={mushCap:new J(.5,8,5),mushStem:new yt(.06,.1,.6,5),mushDot:new J(.06,4,3),crystal:new yt(0,.35,1.8,6),crystalSm:new yt(0,.18,.9,5),fly:new J(.06,4,3),spore:new J(.04,3,3),dandSeed:new J(.025,3,3),bubble:new J(.15,8,6),starMote:new J(.03,3,3),dustMote:new J(.035,3,3)};let _o=42;function S(){return _o=_o*16807%2147483647,(_o&2147483647)/2147483647}function Lv(){return _o}function Dv(s){_o=s}function ur(s,t){let e=s*374761393+t*668265263+1274126177|0;return e=(e^e>>13)*1274126177|0,(e&2147483647)/2147483647}function xo(s){return s*s*(3-2*s)}function Uf(s,t){const e=Math.floor(s),n=Math.floor(t),i=xo(s-e),o=xo(t-n),r=ur(e,n),a=ur(e+1,n),c=ur(e,n+1),l=ur(e+1,n+1);return r+(a-r)*i+(c-r)*o+(r-a-c+l)*i*o}function wu(s,t,e){let n=0,i=.5,o=1;for(let r=0;r<e;r++)n+=Uf(s*o,t*o)*i,i*=.5,o*=2;return n}const ll=[];function hl(s,t,e){ll.push({x:s,z:t,r:e})}function ie(s,t){const e=Math.sqrt(s*s+t*t),n=1-xo(Math.max(0,(e-le*.7)/(le*.3))),i=xo(Math.min(1,e/8)),o=.035,r=wu(s*o,t*o,4),a=wu(s*o*2.7+50,t*o*2.7+50,3),c=Uf(s*.15,t*.15);let l=r*2.5+a*.8+c*.15;l*=n*i;for(let h=0;h<ll.length;h++){const u=ll[h],f=s-u.x,m=t-u.z,g=Math.sqrt(f*f+m*m);if(g<u.r*2){const _=xo(Math.max(0,(g-u.r*.5)/(u.r*1.5)));l*=_}}return l}function Uv(){const t=document.createElement("canvas");t.width=2048,t.height=2048;const e=t.getContext("2d"),n=Math.random;e.fillStyle="#2a5038",e.fillRect(0,0,2048,2048);const i=[{col:"rgba(40,80,50,0.35)",n:15,r:120},{col:"rgba(60,50,25,0.25)",n:12,r:100},{col:"rgba(30,65,55,0.25)",n:10,r:110},{col:"rgba(55,70,35,0.2)",n:8,r:90},{col:"rgba(35,40,25,0.25)",n:8,r:80}];for(const h of i)for(let u=0;u<h.n;u++){const f=n()*2048,m=n()*2048,g=h.r*(.5+n()*.8),_=e.createRadialGradient(f,m,0,f,m,g);_.addColorStop(0,h.col),_.addColorStop(.6,h.col.replace(/[\d.]+\)$/,parseFloat(h.col.match(/[\d.]+\)$/)[0])*.4+")")),_.addColorStop(1,"rgba(0,0,0,0)"),e.fillStyle=_;for(let p=-1;p<=1;p++)for(let d=-1;d<=1;d++)e.beginPath(),e.arc(f+p*2048,m+d*2048,g,0,6.28),e.fill()}const o=[{n:80,r:25,colors:["rgba(20,45,25,0.2)","rgba(35,55,28,0.18)","rgba(28,22,12,0.2)","rgba(15,38,30,0.15)"]},{n:200,r:10,colors:["rgba(30,55,30,0.14)","rgba(45,35,18,0.12)","rgba(22,48,35,0.12)","rgba(38,28,14,0.1)"]},{n:500,r:4,colors:["rgba(25,50,28,0.1)","rgba(40,30,15,0.08)","rgba(18,42,32,0.08)","rgba(32,25,10,0.06)"]}];for(const h of o)for(let u=0;u<h.n;u++){e.fillStyle=h.colors[Math.floor(n()*h.colors.length)];const f=n()*2048,m=n()*2048;e.beginPath(),e.arc(f,m,h.r+n()*h.r*.6,0,6.28),e.fill()}const r=["rgba(60,200,100,0.06)","rgba(50,180,120,0.05)","rgba(80,160,200,0.04)","rgba(100,220,150,0.05)"];for(let h=0;h<25;h++){let u=n()*2048,f=n()*2048;const m=r[Math.floor(n()*r.length)];e.strokeStyle=m,e.lineWidth=1+n()*2,e.beginPath(),e.moveTo(u,f);let g=n()*6.28;const _=12+Math.floor(n()*16);for(let p=0;p<_;p++)g+=Math.sin(p*.6)*.5+(n()-.5)*.4,u+=Math.cos(g)*(6+n()*10),f+=Math.sin(g)*(6+n()*10),e.lineTo(u,f);if(e.stroke(),n()<.6){const p=e.createRadialGradient(u,f,0,u,f,6+n()*8);p.addColorStop(0,m.replace("0.0","0.1")),p.addColorStop(1,"rgba(0,0,0,0)"),e.fillStyle=p,e.beginPath(),e.arc(u,f,6+n()*8,0,6.28),e.fill()}}e.lineWidth=1.2;for(let h=0;h<30;h++){e.strokeStyle=`rgba(20,12,5,${.15+n()*.12})`;let u=n()*2048,f=n()*2048,m=n()*6.28;e.beginPath(),e.moveTo(u,f);for(let g=0;g<10;g++)m+=Math.sin(g*.7)*.5+(n()-.5)*.35,u+=Math.cos(m)*(8+n()*14),f+=Math.sin(m)*(8+n()*14),e.lineTo(u,f);e.stroke()}const a=["rgba(55,32,12,0.3)","rgba(70,42,18,0.25)","rgba(40,55,22,0.22)","rgba(22,50,28,0.2)","rgba(60,45,20,0.25)","rgba(30,60,35,0.18)","rgba(50,25,8,0.22)","rgba(65,55,25,0.18)"];for(let h=0;h<3e3;h++){e.fillStyle=a[Math.floor(n()*a.length)];const u=n()*2048,f=n()*2048,m=.8+n()*2.5;e.beginPath(),e.arc(u,f,m,0,6.28),e.fill()}for(let h=0;h<40;h++){const u=n()*2048,f=n()*2048,m=15+n()*35,g=e.createRadialGradient(u,f,0,u,f,m),_=n();_<.4?(g.addColorStop(0,"rgba(45,90,50,0.18)"),g.addColorStop(1,"rgba(25,55,30,0)")):_<.7?(g.addColorStop(0,"rgba(35,75,60,0.16)"),g.addColorStop(1,"rgba(20,50,38,0)")):(g.addColorStop(0,"rgba(55,75,35,0.14)"),g.addColorStop(1,"rgba(30,45,20,0)")),e.fillStyle=g,e.beginPath(),e.arc(u,f,m,0,6.28),e.fill()}for(let h=0;h<400;h++){const u=n()*2048,f=n()*2048,m=1.5+n()*3.5,g=Math.floor(28+n()*42);e.fillStyle=`rgba(${g},${g-4},${g-10},0.3)`,e.beginPath(),e.arc(u,f,m,0,6.28),e.fill()}e.lineWidth=.7;for(let h=0;h<80;h++){const u=n()*2048,f=n()*2048,m=4+n()*18,g=n()*6.28;e.strokeStyle=`rgba(22,12,5,${.15+n()*.1})`,e.beginPath(),e.moveTo(u,f),e.lineTo(u+Math.cos(g)*m,f+Math.sin(g)*m),e.stroke()}const c=["rgba(80,220,120,0.08)","rgba(60,200,160,0.07)","rgba(100,180,220,0.06)","rgba(120,100,200,0.05)","rgba(200,150,80,0.04)","rgba(60,180,180,0.06)"];for(let h=0;h<300;h++){const u=n()*2048,f=n()*2048,m=c[Math.floor(n()*c.length)];if(e.fillStyle=m,e.beginPath(),e.arc(u,f,1+n()*2,0,6.28),e.fill(),n()<.3){const g=e.createRadialGradient(u,f,0,u,f,4+n()*5);g.addColorStop(0,m),g.addColorStop(1,"rgba(0,0,0,0)"),e.fillStyle=g,e.beginPath(),e.arc(u,f,4+n()*5,0,6.28),e.fill()}}for(let h=0;h<150;h++){const u=n()*2048,f=n()*2048;e.fillStyle=`rgba(120,180,130,${.04+n()*.04})`,e.beginPath(),e.arc(u,f,.5+n()*1.2,0,6.28),e.fill()}const l=new Bl(t);return l.wrapS=l.wrapT=Pr,l.repeat.set(5,5),l.colorSpace=Je,l}function Nv(){const s=Uv(),t=le*3,e=200,n=new Me(t,t,e,e),i=n.attributes.position;n.attributes.uv;for(let r=0;r<i.count;r++){const a=i.getX(r),c=i.getY(r);Math.sqrt(a*a+c*c)<le*1.4?i.setZ(r,ie(a,c)):i.setZ(r,0)}n.computeVertexNormals();const o=new I(n,new tt({map:s,color:15663086,roughness:.75,metalness:0,emissive:1718304,emissiveIntensity:.25}));return o.rotation.x=-Math.PI/2,o.receiveShadow=!0,vt.add(o),o}const ul=new ue;let Vr=null;function _i(s,t){const e=s>>16&255,n=s>>8&255,i=s&255;return`rgba(${e},${n},${i},${t})`}function xi(s,t,e,n,i,o,r){s.save(),s.translate(t,e),Math.abs(i/n-1)>.01&&s.scale(1,i/n);const a=s.createRadialGradient(0,0,0,0,0,n);a.addColorStop(0,_i(o,r)),a.addColorStop(.25,_i(o,r*.55)),a.addColorStop(.55,_i(o,r*.15)),a.addColorStop(.85,_i(o,r*.03)),a.addColorStop(1,_i(o,0)),s.fillStyle=a,s.beginPath(),s.arc(0,0,n,0,6.2832),s.fill(),s.restore()}function Ya(s,t,e,n,i,o,r,a){xi(s,t,e,n,i,o,r),t-n<0&&xi(s,t+a,e,n,i,o,r),t+n>a&&xi(s,t-a,e,n,i,o,r)}function Fv(){const e=document.createElement("canvas");e.width=2048,e.height=1024;const n=e.getContext("2d"),i=Math.random,o=n.createLinearGradient(0,0,0,1024);o.addColorStop(0,"#030610"),o.addColorStop(.2,"#050a18"),o.addColorStop(.4,"#0a1222"),o.addColorStop(.55,"#0c1828"),o.addColorStop(.75,"#081018"),o.addColorStop(1,"#040810"),n.fillStyle=o,n.fillRect(0,0,2048,1024);const r=[{x:.12,y:.22,rx:.18,ry:.14,col:1717094,a:.14},{x:.42,y:.28,rx:.22,ry:.1,col:2758741,a:.12},{x:.72,y:.18,rx:.16,ry:.12,col:1721446,a:.13},{x:.88,y:.32,rx:.2,ry:.09,col:3348548,a:.1},{x:.28,y:.12,rx:.14,ry:.18,col:2245768,a:.1},{x:.58,y:.38,rx:.18,ry:.07,col:4465220,a:.08},{x:.05,y:.4,rx:.15,ry:.1,col:1586005,a:.09},{x:.52,y:.15,rx:.12,ry:.16,col:2765670,a:.07}];for(const u of r){Ya(n,u.x*2048,u.y*1024,u.rx*2048,u.ry*1024,u.col,u.a,2048);for(let f=0;f<4;f++){const m=(u.x+(i()-.5)*u.rx)*2048,g=(u.y+(i()-.5)*u.ry)*1024,_=u.rx*2048*(.2+i()*.35),p=u.ry*1024*(.2+i()*.4);Ya(n,m,g,_,p,u.col,u.a*(.4+i()*.5),2048)}}const a=[2245802,2245734,4465254,5583701,3368584,2245717,3809894];for(let u=0;u<30;u++){const f=i()*2048,m=i()*1024*.55,g=40+i()*180,_=25+i()*100;Ya(n,f,m,g,_,a[Math.floor(i()*a.length)],.025+i()*.035,2048)}n.save(),n.globalCompositeOperation="screen";const c=.26;for(let u=0;u<50;u++){const f=u/50,m=f*2048,g=(c+Math.sin(f*Math.PI)*.06+(i()-.5)*.02)*1024,_=2048*.05+i()*2048*.035,p=1024*.04*(.4+i()*.6);xi(n,m,g,_,p,4478310,.025+i()*.015)}for(let u=0;u<25;u++){const f=.2+i()*.6,m=f*2048,g=(c+Math.sin(f*Math.PI)*.04)*1024;xi(n,m,g,2048*.03+i()*2048*.02,1024*.02+i()*1024*.01,6719658,.015+i()*.012)}for(let u=0;u<10;u++){const f=.35+i()*.3,m=f*2048,g=(c+Math.sin(f*Math.PI)*.02)*1024;xi(n,m,g,2048*.02,1024*.012,8943462,.01+i()*.008)}n.globalCompositeOperation="source-over",n.restore();for(let u=0;u<12;u++){const f=.1+i()*.8,m=f*2048,g=(c+Math.sin(f*Math.PI)*.04+(i()-.5)*.02)*1024,_=20+i()*60,p=8+i()*20;xi(n,m,g,_,p,132104,.15+i()*.1)}const l=["255,255,255","220,230,255","255,240,220","200,215,255","255,225,200","240,240,255","255,245,235"];for(let u=0;u<5e3;u++){const f=i()*2048,m=i()*1024*.65,g=.3+i()*.7,_=.1+i()*.5;n.fillStyle=`rgba(${l[Math.floor(i()*l.length)]},${_})`,n.beginPath(),n.arc(f,m,g,0,6.28),n.fill()}for(let u=0;u<3e3;u++){const f=i(),m=f*2048,_=(c+Math.sin(f*Math.PI)*.06)*1024+(i()-.5)*1024*.1;if(_<0||_>1024*.6)continue;const p=.2+i()*.6,d=.2+i()*.7;n.fillStyle=`rgba(${l[Math.floor(i()*l.length)]},${d})`,n.beginPath(),n.arc(m,_,p,0,6.28),n.fill()}for(let u=0;u<60;u++){const f=i()*2048,m=i()*1024*.58,g=1.2+i()*1.8,_=6+i()*14,p=i();let d;p<.45?d="255,255,255":p<.65?d="210,225,255":p<.8?d="255,230,200":p<.92?d="190,210,255":d="255,200,180";const y=n.createRadialGradient(f,m,0,f,m,_);y.addColorStop(0,`rgba(${d},0.5)`),y.addColorStop(.1,`rgba(${d},0.18)`),y.addColorStop(.35,`rgba(${d},0.04)`),y.addColorStop(1,`rgba(${d},0)`),n.fillStyle=y,n.beginPath(),n.arc(f,m,_,0,6.28),n.fill(),n.strokeStyle=`rgba(${d},0.12)`,n.lineWidth=.5;const v=_*.8;n.beginPath(),n.moveTo(f-v,m),n.lineTo(f+v,m),n.moveTo(f,m-v),n.lineTo(f,m+v),n.stroke(),n.fillStyle=`rgba(${d},1)`,n.beginPath(),n.arc(f,m,g,0,6.28),n.fill()}for(let u=0;u<8;u++){const f=i()*2048,m=1024*.08+i()*1024*.42,g=50+i()*90;xi(n,f,m,g,g*.7,3359846,.03);for(let _=0;_<100;_++){const p=i()*6.28,d=i()*i()*g,y=f+Math.cos(p)*d,v=m+Math.sin(p)*d*.65;if(y<0||y>2048||v<0||v>1024)continue;const x=.2+i()*.6;n.fillStyle=`rgba(255,255,255,${.25+i()*.6})`,n.beginPath(),n.arc(y,v,x,0,6.28),n.fill()}}for(let u=0;u<15;u++){const f=r[Math.floor(i()*r.length)],m=(f.x+(i()-.5)*f.rx*.5)*2048,g=(f.y+(i()-.5)*f.ry*.5)*1024,_=3+i()*8,p=n.createRadialGradient(m,g,0,m,g,_*3);p.addColorStop(0,_i(f.col,.2)),p.addColorStop(.3,_i(f.col,.06)),p.addColorStop(1,_i(f.col,0)),n.fillStyle=p,n.beginPath(),n.arc(m,g,_*3,0,6.28),n.fill()}const h=new Bl(e);return h.colorSpace=Je,h}function Ov(){const s=Lv(),t=Fv(),e=new J(uv,64,32);Vr=new K({map:t,side:je,fog:!1,transparent:!1});const n=new I(e,Vr);ul.add(n),vt.add(ul),Dv(s)}function Nf(s,t){ul.rotation.y=t*.003}function zv(s){if(Vr){const t=Math.max(.15,s);Vr.color.setRGB(t,t,t)}}const st={pos:new D(0,sa,0),vel:new D,onGround:!0};let Su=0,qa=0,Ff=0,Za=65,bu=65,to=0,Eu=!0,$a=0,Fs=0,fl=[],dl=[],pl=null;function Bv(s,t){fl=s,dl=t}function kv(s){pl=s}function Gv(s){const t=Iv(),e=Ce.ShiftLeft||Ce.ShiftRight||Do;st.vel.x=t.x,st.vel.z=t.z,st.vel.y-=Xx*s,(Ce.Space||ra)&&st.onGround&&(st.vel.y=Br,st.onGround=!1,Rv(!1)),st.onGround||($a=st.vel.y),st.pos.x+=st.vel.x*s,st.pos.y+=st.vel.y*s,st.pos.z+=st.vel.z*s;const n=ie(st.pos.x,st.pos.z)+sa;if(st.pos.y<=n){if(st.pos.y=n,st.vel.y=0,!Eu&&$a<-3){const h=Math.min(Math.abs($a)/Br,1);to=h*.15,pl&&pl(st.pos.x,st.pos.z,Math.floor(3+h*5))}st.onGround=!0}Eu=st.onGround,st.onGround?(st.vel.x*=gu,st.vel.z*=gu):(st.vel.x*=_u,st.vel.z*=_u);const i=.4;for(let h=0;h<fl.length;h++){const u=fl[h],f=st.pos.x-u.x,m=st.pos.z-u.z,g=f*f+m*m,_=.6+i;if(g<_*_&&g>.001){const p=1/Math.sqrt(g);st.pos.x=u.x+f*p*_,st.pos.z=u.z+m*p*_}}for(let h=0;h<dl.length;h++){const u=dl[h],f=st.pos.x-u.x,m=st.pos.z-u.z,g=f*f+m*m,_=u.colR+i;if(g<_*_&&g>.001){const p=1/Math.sqrt(g);st.pos.x=u.x+f*p*_,st.pos.z=u.z+m*p*_}}if(Math.sqrt(st.pos.x*st.pos.x+st.pos.z*st.pos.z)>le){const h=Math.atan2(st.pos.z,st.pos.x);st.pos.x=Math.cos(h)*le,st.pos.z=Math.sin(h)*le}Zl.position.copy(st.pos);const a=Math.sqrt(t.x*t.x+t.z*t.z)>.5&&st.onGround;a?Fs=0:Fs+=s,qa+=((a?e?.06:.035:0)-qa)*s*6,a&&(Su+=s*(e?12:8));const l=Math.sin(Su)*qa;bu=e&&a?78:65,Za+=(bu-Za)*s*4,Ke.fov=Za,Ke.updateProjectionMatrix(),to*=Math.pow(.04,s),to<.001&&(to=0),Ff=l-to}const Tu=[{leaf:1332520,glow:2280567,core:4521898},{leaf:931880,glow:3390378,core:5636044},{leaf:1721376,glow:4508757,core:7864200},{leaf:1060912,glow:2267562,core:4513262},{leaf:1583172,glow:3377356,core:5618687}];function Hv(s,t){const e=new ue,n=6+S()*10,i=.2+S()*.3,o=new tt({color:3811352,roughness:.8,emissive:1321496,emissiveIntensity:.12}),r=new I(new yt(i*.4,i,n,6),o);r.position.y=n/2,r.castShadow=!0,e.add(r);const a=new tt({color:2263125,emissive:G.leafGlow,emissiveIntensity:.5,transparent:!0,opacity:.25}),c=2+Math.floor(S()*3);for(let y=0;y<c;y++){const v=y/c*6.28+S()*.5,x=n*.4+S()*n*.4,E=new I(new yt(.008,.015,x,3),a);E.position.set(Math.cos(v)*i*.74,n*.15+x/2,Math.sin(v)*i*.74),e.add(E)}const l=new tt({color:2759696,roughness:.85,emissive:1188368,emissiveIntensity:.08}),h=3+Math.floor(S()*3);for(let y=0;y<h;y++){const v=y/h*6.28+S()*.5,x=.8+S()*1.5,E=new I(new yt(.02,i*.3,x,4),l);E.position.set(Math.cos(v)*i*.5,.08,Math.sin(v)*i*.5),E.rotation.z=v<3.14?1.2+S()*.3:-(1.2+S()*.3),E.rotation.y=v,e.add(E)}const u=3+Math.floor(S()*4);for(let y=0;y<u;y++){const v=n*(.4+S()*.5),x=S()*Math.PI*2,E=1.5+S()*3,T=new I(new yt(.02,.06,E,4),o);T.position.set(Math.cos(x)*.3,v,Math.sin(x)*.3),T.rotation.z=(S()-.5)*1.2,T.rotation.y=x,T.castShadow=!0,e.add(T);const b=Tu[Math.floor(S()*Tu.length)],A=Math.cos(x)*(E*.5),w=v+S()*1.5,M=Math.sin(x)*(E*.5),P=1+S()*2,F=new tt({color:b.core,emissive:b.core,emissiveIntensity:.7+S()*.5,transparent:!0,opacity:.55,roughness:.3}),U=new I(new Wi(P*.3,1),F);U.position.set(A,w,M),e.add(U);const z=new tt({color:b.leaf,emissive:b.glow,emissiveIntensity:.25+S()*.25,transparent:!0,opacity:.55,roughness:.7}),V=new I(new Wi(P*.75,1),z);V.position.set(A+(S()-.5)*.4,w+(S()-.5)*.4,M+(S()-.5)*.4),V.scale.set(1+S()*.4,.65+S()*.5,1+S()*.4),V.castShadow=!0,V.receiveShadow=!0,e.add(V);const H=new tt({color:b.glow,emissive:b.glow,emissiveIntensity:.12,transparent:!0,opacity:.08,depthWrite:!1}),$=new I(new Wi(P*1.2,1),H);if($.position.set(A,w,M),e.add($),S()<.35){const q=new tt({color:2773040,emissive:1135904,emissiveIntensity:.08,transparent:!0,opacity:.5}),rt=.3+S()*.8,ft=new I(new yt(.008,.003,rt,3),q),St=S()*E*.4;ft.position.set(Math.cos(x)*(.3+St),v-rt/2-S()*.3,Math.sin(x)*(.3+St)),e.add(ft)}}const f=new tt({color:5911840,emissive:3349e3,emissiveIntensity:.06,roughness:.8}),m=Math.floor(S()*3);for(let y=0;y<m;y++){const v=1+S()*n*.4,x=S()*6.28,E=new I(new J(.08+S()*.08,5,3),f);E.scale.set(1.5,.3,1),E.position.set(Math.cos(x)*i*.8,v,Math.sin(x)*i*.8),E.rotation.y=-x,e.add(E)}const g=new tt({color:G.leaf,emissive:G.leafGlow,emissiveIntensity:.06,transparent:!0,opacity:.07,depthWrite:!1}),_=new I(new J(3+S()*2,8,6),g);_.position.y=n*.65,e.add(_);const p=new tt({color:1183752,roughness:.95}),d=new I(new J(i*2.5,6,3),p);return d.scale.set(1,.12,1),d.position.y=.02,e.add(d),e.position.set(s,0,t),vt.add(e),e}function Vv(s,t){const e=new ue,n=.4+S()*1.2,i=S()*6.28,o=.8+S()*1.5,r=.5+S()*.8,a=new I(hn.mushStem,new tt({color:G.mushStem,roughness:.7,emissive:G.mushGlow,emissiveIntensity:.1}));a.position.y=.3,e.add(a);const c=new tt({color:G.mushStem,emissive:G.mushGlow,emissiveIntensity:.15,roughness:.6}),l=new I(new be(.09,.012,4,8),c);l.position.y=.42,l.rotation.x=Math.PI/2,e.add(l);const h=new tt({color:G.mushCap,emissive:G.mushGlow,emissiveIntensity:r,roughness:.3,transparent:!0,opacity:.9}),u=new I(hn.mushCap,h);u.scale.set(1,.5,1),u.position.y=.55,u.castShadow=!0,u.receiveShadow=!0,e.add(u);const f=new tt({color:6693546,emissive:G.mushGlow,emissiveIntensity:.3,transparent:!0,opacity:.5,side:kt});for(let M=0;M<8;M++){const P=M/8*6.28,F=new I(new Me(.35,.08),f);F.position.set(Math.cos(P)*.15,.48,Math.sin(P)*.15),F.rotation.y=-P,F.rotation.x=.1,e.add(F)}for(let M=0;M<4;M++){const P=new K({color:16777215,transparent:!0,opacity:.9}),F=new I(hn.mushDot,P),U=S()*6.28,z=.15+S()*.25;F.position.set(Math.cos(U)*z,.6+S()*.1,Math.sin(U)*z),e.add(F)}const m=new tt({color:15663103,emissive:11197951,emissiveIntensity:.2,transparent:!0,opacity:.6,roughness:0,metalness:.5}),g=2+Math.floor(S()*2);for(let M=0;M<g;M++){const P=new I(new J(.015+S()*.015,4,3),m),F=S()*6.28,U=.1+S()*.2;P.position.set(Math.cos(F)*U,.63+S()*.08,Math.sin(F)*U),e.add(P)}const _=new tt({color:4465322,emissive:G.mushGlow,emissiveIntensity:.15,transparent:!0,opacity:.35});for(let M=0;M<4;M++){const P=S()*6.28,F=.15+S()*.25,U=new I(new yt(.004,.002,F,3),_);U.position.set(Math.cos(P)*.12,.01,Math.sin(P)*.12),U.rotation.z=1.3*(P<3.14?1:-1),U.rotation.y=P,e.add(U)}const p=new tt({color:G.mushCap,emissive:G.mushGlow,emissiveIntensity:r*.6,transparent:!0,opacity:.4}),d=new I(new be(.38,.01,4,12),p);d.position.y=.49,d.rotation.x=Math.PI/2,e.add(d);const y=new tt({color:G.mushStem,emissive:G.mushGlow,emissiveIntensity:.08,roughness:.7}),v=new I(new J(.08,5,3),y);v.scale.set(1,.5,1),v.position.y=.04,e.add(v);const x=new tt({color:1708040,roughness:.95});for(let M=0;M<3;M++){const P=S()*6.28,F=.1+S()*.12,U=new I(new J(.008+S()*.008,3,3),x);U.position.set(Math.cos(P)*F,.005,Math.sin(P)*F),e.add(U)}const E=new K({color:G.mushGlow,transparent:!0,opacity:.2});for(let M=0;M<4;M++){const P=new I(new J(.006,3,3),E);P.position.set((S()-.5)*.2,.35+S()*.1,(S()-.5)*.2),e.add(P)}const T=new tt({color:11167453,emissive:G.mushGlow,emissiveIntensity:r*.3,roughness:.5}),b=3+Math.floor(S()*3);for(let M=0;M<b;M++){const P=S()*6.28,F=S()*.25,U=new I(new J(.015+S()*.015,3,3),T);U.position.set(Math.cos(P)*F,.58+S()*.06,Math.sin(P)*F),e.add(U)}const A=new tt({color:657416,transparent:!0,opacity:.2,roughness:.95,side:kt}),w=new I(new Fe(.18,8),A);return w.rotation.x=-Math.PI/2,w.position.y=.005,e.add(w),e.scale.setScalar(n),e.position.set(s,0,t),vt.add(e),{group:e,capMat:h,phase:i,speed:o,base:r,x:s,z:t}}function Wv(s,t){const e=new ue,n=S()*6.28,i=new tt({color:G.crystal,emissive:G.crystalCore,emissiveIntensity:1.5,transparent:!0,opacity:.7,roughness:.1,metalness:.5}),o=new I(hn.crystal,i);o.position.y=.9,o.castShadow=!0,e.add(o);for(let v=0;v<3;v++){const x=new I(hn.crystalSm,i),E=v/3*6.28+S()*.5;x.position.set(Math.cos(E)*.4,.45,Math.sin(E)*.4),x.rotation.z=(S()-.5)*.8,x.castShadow=!0,e.add(x)}const r=new tt({color:1710626,roughness:.9,metalness:.1}),a=3+Math.floor(S()*3);for(let v=0;v<a;v++){const x=S()*6.28,E=.2+S()*.5,T=.08+S()*.12,b=new I(new J(T,4,3),r);b.scale.set(1+S()*.5,.5+S()*.4,1+S()*.5),b.position.set(Math.cos(x)*E,T*.3,Math.sin(x)*E),b.rotation.set(S(),S(),S()),e.add(b)}const c=new K({color:G.crystalCore,transparent:!0,opacity:.5});for(let v=0;v<3;v++){const x=.4+S()*.8,E=new I(new yt(.008,.008,x,3),c);E.position.set((S()-.5)*.15,.5+S()*.7,(S()-.5)*.15),E.rotation.set((S()-.5)*.8,(S()-.5)*.5,(S()-.5)*.8),e.add(E)}const l=new K({color:11206638,transparent:!0,opacity:.6});for(let v=0;v<5;v++){const x=new I(new J(.012,3,3),l);x.position.set((S()-.5)*1,.3+S()*1.5,(S()-.5)*1),e.add(x)}const h=new tt({color:G.crystal,emissive:G.crystalCore,emissiveIntensity:.8,transparent:!0,opacity:.5});for(let v=0;v<4;v++){const x=S()*6.28,E=.3+S()*.3,T=new I(new yt(0,.015,.12+S()*.1,3),h);T.position.set(Math.cos(x)*E,.06+S()*.1,Math.sin(x)*E),T.rotation.z=(S()-.5)*.6,e.add(T)}const u=new tt({color:3364198,emissive:1122867,emissiveIntensity:.05,roughness:.9,side:kt});for(let v=0;v<2;v++){const x=S()*6.28,E=.2+S()*.3,T=new I(new Fe(.04+S()*.03,5),u);T.rotation.x=-Math.PI/2+S()*.4,T.position.set(Math.cos(x)*E,.05,Math.sin(x)*E),e.add(T)}const f=new K({color:G.crystalCore,transparent:!0,opacity:.2});for(let v=0;v<2;v++){const x=new I(new yt(.003,.003,.6+S()*.4,3),f);x.position.set((S()-.5)*.3,.7+S()*.5,(S()-.5)*.3),x.rotation.set((S()-.5)*1,S(),(S()-.5)*1),e.add(x)}const m=new tt({color:1135940,emissive:1127202,emissiveIntensity:.3,transparent:!0,opacity:.25});for(let v=0;v<4;v++){const x=new I(new J(.02+S()*.02,3,3),m);x.position.set((S()-.5)*.15,.4+S()*.6,(S()-.5)*.15),e.add(x)}const g=new K({color:11206638,transparent:!0,opacity:.06}),_=new I(new be(.35,.02,4,10),g);_.position.y=.6,_.rotation.x=Math.PI/2+S()*.3,e.add(_);const p=new K({color:G.crystal,transparent:!0,opacity:.06,side:kt}),d=new I(new Fe(.8,8),p);d.rotation.x=-Math.PI/2,d.position.y=.01,e.add(d),e.position.set(s,0,t),vt.add(e);const y=new ji(G.crystal,.5,8);return y.position.set(s,1.2,t),vt.add(y),{group:e,mat:i,phase:n,x:s,z:t,light:y}}function Xv(s,t,e,n){const i=new Ie,o=[],r=[],a=[],c=n||20,l=new lt(663568),h=new lt(1388056),u=new lt(2777141),f=new lt(4517461),m=new lt(7864268),g=new lt(14548838),_=new lt;for(let T=0;T<c;T++){const b=S()*6.28,A=S()*e,w=Math.cos(b)*A,M=Math.sin(b)*A,P=.25+S()*.65,F=.03+S()*.05,U=(S()-.5)*.2,z=(S()-.5)*.2,V=(S()-.5)*.12,H=S()<.5?l:h,$=S(),q=$<.4?f:$<.7?m:g,rt=P*.35,ft=P*.7,St=U*.3,Bt=U*.7,Zt=z*.3,j=z*.7;o.push(w-F,.01,M),o.push(w+F,.01,M),o.push(w+St-F*.9,rt,M+Zt),a.push(0,0,.35),r.push(H.r,H.g,H.b,H.r,H.g,H.b),_.copy(H).lerp(u,.4),r.push(_.r,_.g,_.b),o.push(w+F,.01,M),o.push(w+St+F*.9,rt,M+Zt),o.push(w+St-F*.9,rt,M+Zt),a.push(0,.35,.35),r.push(H.r,H.g,H.b),_.copy(H).lerp(u,.4),r.push(_.r,_.g,_.b,_.r,_.g,_.b);const ct=F*.65;o.push(w+St-F*.9,rt,M+Zt),o.push(w+St+F*.9,rt,M+Zt),o.push(w+Bt-ct,ft,M+j+V),a.push(.35,.35,.7),_.copy(H).lerp(u,.4),r.push(_.r,_.g,_.b,_.r,_.g,_.b),_.copy(u).lerp(q,.3),r.push(_.r,_.g,_.b),o.push(w+St+F*.9,rt,M+Zt),o.push(w+Bt+ct,ft,M+j+V),o.push(w+Bt-ct,ft,M+j+V),a.push(.35,.7,.7),_.copy(H).lerp(u,.4),r.push(_.r,_.g,_.b),_.copy(u).lerp(q,.3),r.push(_.r,_.g,_.b,_.r,_.g,_.b),o.push(w+Bt-ct,ft,M+j+V),o.push(w+Bt+ct,ft,M+j+V),o.push(w+U+V*2,P,M+z+V*1.5),a.push(.7,.7,1),_.copy(u).lerp(q,.3),r.push(_.r,_.g,_.b,_.r,_.g,_.b),r.push(q.r,q.g,q.b)}const p=new lt(1725736),d=Math.floor(c*.3);for(let T=0;T<d;T++){const b=S()*6.28,A=S()*e*.9,w=Math.cos(b)*A,M=Math.sin(b)*A,P=.02+S()*.03;o.push(w-P,.01,M),o.push(w+P,.01,M),o.push(w,.03+S()*.02,M+P),a.push(0,0,.05),r.push(p.r,p.g,p.b),r.push(p.r,p.g,p.b);const F=new lt(3385941);r.push(F.r,F.g,F.b)}const y=new Xt(o,3);y.setUsage(vn),i.setAttribute("position",y),i.setAttribute("color",new Xt(r,3)),i.setAttribute("bladeHeight",new Xt(a,1)),i.computeVertexNormals();const v=new Float32Array(o.length);v.set(y.array);const x=new tt({vertexColors:!0,roughness:.7,side:kt,emissive:4521830,emissiveIntensity:.08}),E=new I(i,x);return E.position.set(s,0,t),vt.add(E),{mesh:E,geo:i,cx:s,cz:t,origPos:v}}function Yv(s,t,e,n,i,o,r){const a=s.geo.attributes.position.array,c=s.geo.attributes.bladeHeight.array,l=s.origPos,h=s.cx,u=s.cz,f=o-h,m=r-u;for(let g=0,_=c.length;g<_;g++){const p=c[g];if(p<.01)continue;const d=g*3,y=l[d],v=l[d+1],x=l[d+2],E=(Math.sin(t*.7+(h+y)*.05)*.06+Math.sin(t*1.3+(u+x)*.08)*.03)*e*p*p,T=(Math.sin(t*.9+(u+x)*.06)*.04+Math.sin(t*1.7+(h+y)*.04)*.02)*e*p*p;let b=E+n*p,A=T+i*p;const w=y-f,M=x-m,P=w*w+M*M;if(P<1.44){const F=1-Math.sqrt(P)/1.2,U=F*F*.7,z=Math.atan2(w,M);b+=Math.sin(z)*U*p*.15,A+=Math.cos(z)*U*p*.15,a[d+1]=v*(1-U*p)}else a[d+1]=v;a[d]=y+b,a[d+2]=x+A}s.geo.attributes.position.needsUpdate=!0}function qv(s,t){const e=new ue,n=new tt({color:G.fern,emissive:G.fernGlow,emissiveIntensity:.08,roughness:.7,side:kt}),i=3+Math.floor(S()*2),o=.5+S()*.7,r=new tt({color:1708552,roughness:.95}),a=new I(new J(.06,5,3),r);a.scale.set(1.5,.5,1.5),a.position.y=.02,e.add(a);for(let d=0;d<3;d++){const y=S()*6.28,v=new I(new yt(.003,.002,.08,3),r);v.position.set(Math.cos(y)*.06,.01,Math.sin(y)*.06),v.rotation.z=(y<3.14?1:-1)*1.2,v.rotation.y=y,e.add(v)}for(let d=0;d<i;d++){const y=d/i*6.28+S()*.3,v=new I(new yt(.004,.006,.55,3),new tt({color:1721632,roughness:.8}));v.position.set(Math.cos(y)*.15,.25,Math.sin(y)*.15),v.rotation.y=-y,v.rotation.x=-.6-S()*.4,e.add(v);const x=new I(new Me(.12,.6,1,3),n);x.position.set(Math.cos(y)*.15,.25,Math.sin(y)*.15),x.rotation.y=-y,x.rotation.x=-.6-S()*.4,e.add(x);for(let T=0;T<6;T++){const b=new I(new Me(.07,.06,1,1),n),A=.06+T*.08,w=T%2===0?1:-1;b.position.set(Math.cos(y)*(.15+.06),A,Math.sin(y)*(.15+.06*w)),b.rotation.y=-y,b.rotation.x=-.8,b.rotation.z=w*.5,e.add(b)}const E=new tt({color:8939042,emissive:4469521,emissiveIntensity:.1});for(let T=0;T<3;T++){const b=new I(new J(.008,3,3),E),A=.12+T*.12;b.position.set(Math.cos(y)*(.15+.02),A-.01,Math.sin(y)*(.15+.02)),e.add(b)}}const c=new tt({color:G.fernGlow,emissive:G.fernGlow,emissiveIntensity:.3}),l=new I(new J(.04,4,3),c);l.position.y=.35,e.add(l);const h=new I(new yt(.006,.003,.06,3),c);h.position.set(.02,.37,0),h.rotation.z=-.8,e.add(h);const u=new tt({color:15663103,emissive:8960989,emissiveIntensity:.1,transparent:!0,opacity:.5,roughness:0,metalness:.5});for(let d=0;d<3;d++){const y=S()*6.28,v=S()*.2,x=new I(new J(.006+S()*.005,3,3),u);x.position.set(Math.cos(y)*v,.12+S()*.2,Math.sin(y)*v),e.add(x)}const f=new tt({color:3811856,roughness:.9,side:kt,transparent:!0,opacity:.6}),m=new I(new Me(.1,.4,1,2),f),g=S()*6.28;m.position.set(Math.cos(g)*.12,.05,Math.sin(g)*.12),m.rotation.x=-1.3,m.rotation.y=g,e.add(m);const _=new K({color:2768928,transparent:!0,opacity:.3});for(let d=0;d<4;d++){const y=new I(new yt(.001,.001,.015,3),_);y.position.set((S()-.5)*.08,.08+S()*.15,(S()-.5)*.08),y.rotation.z=(S()-.5)*1.5,e.add(y)}const p=new tt({color:1708552,roughness:.95});for(let d=0;d<3;d++){const y=new I(new J(.006,3,3),p);y.position.set((S()-.5)*.1,.005,(S()-.5)*.1),e.add(y)}return e.scale.setScalar(o),e.position.set(s,0,t),vt.add(e),{group:e,phase:S()*6.28}}function Zv(s,t){const e=new ue,n=.25+S()*.4,i=new tt({color:G.flowerStem,roughness:.8}),o=new I(new yt(.01,.015,n,4),i);o.position.y=n/2,e.add(o);for(let A=0;A<2;A++){const w=new I(new Xn(.004,.012,3),i);w.position.set(.012,n*.25+A*n*.25,0),w.rotation.z=-1.2,e.add(w)}const r=new tt({color:G.fern,roughness:.7,side:kt}),a=new I(new Me(.06,.04),r);a.position.set(.03,n*.3,0),a.rotation.z=-.5,e.add(a);const c=new I(new Me(.05,.035),r);c.position.set(-.025,n*.5,.01),c.rotation.z=.6,e.add(c);const l=new tt({color:1728560,roughness:.7,side:kt});for(let A=0;A<5;A++){const w=A/5*6.28+.3,M=new I(new Me(.025,.02),l);M.position.set(Math.cos(w)*.025,n-.005,Math.sin(w)*.025),M.rotation.x=-1.2,M.rotation.y=-w,e.add(M)}const h=new tt({color:G.flower,emissive:G.flowerGlow,emissiveIntensity:.4+S()*.4,transparent:!0,opacity:.85,side:kt});for(let A=0;A<6;A++){const w=A/6*6.28,M=new I(new Me(.05,.04),h);M.position.set(Math.cos(w)*.03,n+.01,Math.sin(w)*.03),M.rotation.x=-.8,M.rotation.y=-w,e.add(M)}const u=new tt({color:16777215,emissive:G.flowerGlow,emissiveIntensity:1.2}),f=new I(new J(.02,4,3),u);f.position.y=n+.02,e.add(f);const m=new K({color:16777130,transparent:!0,opacity:.7}),g=new K({color:16772676});for(let A=0;A<3;A++){const w=A/3*6.28+.5,M=new I(new yt(.002,.002,.025,3),m);M.position.set(Math.cos(w)*.012,n+.03,Math.sin(w)*.012),e.add(M);const P=new I(new J(.005,3,3),g);P.position.set(Math.cos(w)*.012,n+.045,Math.sin(w)*.012),e.add(P)}const _=new K({color:16777164,transparent:!0,opacity:.3});for(let A=0;A<2;A++){const w=new I(new J(.006,3,3),_);w.position.set((S()-.5)*.04,n+.06+S()*.04,(S()-.5)*.04),e.add(w)}const p=new tt({color:16772778,emissive:16768324,emissiveIntensity:.2,transparent:!0,opacity:.5,roughness:0,metalness:.4}),d=new I(new J(.006,3,3),p);d.position.set(.005,n+.005,.005),e.add(d);const y=new K({color:15662984}),v=new I(new yt(.002,.002,.03,3),y);v.position.y=n+.035,e.add(v);const x=new I(new J(.005,3,3),y);x.position.y=n+.055,e.add(x);const E=new tt({color:1725728,roughness:.7}),T=new I(new yt(.015,.02,.02,5),E);T.position.y=n-.01,e.add(T);const b=new K({color:16777215,transparent:!0,opacity:.35});for(let A=0;A<4;A++){const w=A/4*6.28+.3,M=new I(new J(.004,3,3),b);M.position.set(Math.cos(w)*.045,n+.005,Math.sin(w)*.045),e.add(M)}return e.position.set(s,0,t),vt.add(e),{group:e,petalMat:h,phase:S()*6.28,baseH:n}}function $v(s,t){const e=new ue,n=new tt({color:G.reed,emissive:G.reedTip,emissiveIntensity:.05,roughness:.7}),i=new tt({color:G.reedTip,emissive:G.reedTip,emissiveIntensity:.15}),o=new tt({color:1709328,roughness:.95}),r=new I(new J(.08,5,3),o);r.scale.set(1.5,.4,1.5),r.position.y=.02,e.add(r);const a=3+Math.floor(S()*4),c=new tt({color:G.reed,roughness:.7,side:kt});for(let m=0;m<a;m++){const g=.6+S()*1,_=(S()-.5)*.2,p=(S()-.5)*.2,d=new I(new yt(.008,.015,g,4),n);d.position.set(_,g/2,p),e.add(d);const y=2+Math.floor(S()*2),v=new tt({color:2771488,roughness:.7});for(let T=0;T<y;T++){const b=g*.2+T*g*.25,A=new I(new be(.012,.004,4,6),v);A.position.set(_,b,p),A.rotation.x=Math.PI/2,e.add(A)}if(S()<.7){const T=.1+S()*.15,b=S()*6.28,A=new I(new Me(.02,T),c);A.position.set(_+Math.cos(b)*.02,g*.4,p+Math.sin(b)*.02),A.rotation.y=-b,A.rotation.x=-.5-S()*.4,e.add(A)}const x=new I(new J(.025,4,3),i);x.scale.set(.8,1.5,.8),x.position.set(_,g+.02,p),e.add(x);const E=new K({color:G.reedTip,transparent:!0,opacity:.4});for(let T=0;T<3;T++){const b=T/3*6.28+S()*.5,A=new I(new yt(.002,.001,.04,3),E);A.position.set(_+Math.cos(b)*.015,g+.05,p+Math.sin(b)*.015),A.rotation.z=(S()-.5)*.4,e.add(A)}}e.position.set(s,0,t),vt.add(e);const l=new tt({color:4864536,roughness:.9,side:kt,transparent:!0,opacity:.5});for(let m=0;m<2;m++){S()*6.28;const g=(S()-.5)*.15,_=new I(new Me(.025,.02),l);_.position.set(g,.2+m*.25,(S()-.5)*.1),_.rotation.set(S()*.5,S(),S()*.5),e.add(_)}const h=new K({color:15654348,transparent:!0,opacity:.25});for(let m=0;m<3;m++){const g=new I(new J(.005,3,3),h);g.position.set((S()-.5)*.15,.8+S()*.6,(S()-.5)*.15),e.add(g)}const u=new tt({color:2241312,roughness:.9,transparent:!0,opacity:.2}),f=new I(new be(.1,.008,4,8),u);return f.rotation.x=Math.PI/2,f.position.y=.03,e.add(f),{group:e,phase:S()*6.28,swayAmp:.03+S()*.04}}let en=null;const Ss=[],We=new _e,Wr=new lt,Of=new lt(G.dandSeed);function Kv(s){const t=new K({color:16777215,transparent:!0,opacity:1});en=new Hs(hn.dandSeed,t,s),en.instanceMatrix.setUsage(vn),en.instanceColor=new yi(new Float32Array(s*3),3),en.instanceColor.setUsage(vn),We.scale.setScalar(0),We.updateMatrix();for(let e=0;e<s;e++)en.setMatrixAt(e,We.matrix),Wr.copy(Of),en.setColorAt(e,Wr),Ss.push({x:0,y:0,z:0,vx:0,vy:0,vz:0,life:0,max:0,active:!1,drift:0});en.count=s,vt.add(en)}function Jv(s,t,e){let n=null;for(let o=0;o<Ss.length;o++)if(!Ss[o].active){n=Ss[o];break}if(!n)return;n.x=s+(Math.random()-.5)*.1,n.y=t,n.z=e+(Math.random()-.5)*.1;const i=Math.random()*6.28;n.vx=Math.cos(i)*.5+Math.random()*.3,n.vy=.6+Math.random()*.8,n.vz=Math.sin(i)*.5,n.life=4+Math.random()*5,n.max=n.life,n.active=!0,n.drift=Math.random()*6.28}function jv(s,t){let e=!1;for(let n=0;n<Ss.length;n++){const i=Ss[n];if(!i.active){We.position.set(0,-100,0),We.scale.setScalar(0),We.updateMatrix(),en.setMatrixAt(n,We.matrix);continue}if(i.life-=s,i.life<=0){i.active=!1,We.position.set(0,-100,0),We.scale.setScalar(0),We.updateMatrix(),en.setMatrixAt(n,We.matrix);continue}i.drift+=(Math.random()-.5)*1.5*s,i.vx+=Math.sin(i.drift)*.3*s,i.vz+=Math.cos(i.drift)*.2*s,i.vy+=(.15-i.vy)*s*.5,i.vx*=.998,i.vy*=.998,i.vz*=.998,i.x+=i.vx*s,i.y+=i.vy*s,i.z+=i.vz*s;const r=i.life/i.max*.7*(.6+Math.sin(t*2+n)*.4),a=.8+Math.sin(t*3+n*.5)*.3;We.position.set(i.x,i.y,i.z),We.scale.setScalar(a),We.updateMatrix(),en.setMatrixAt(n,We.matrix),Wr.copy(Of).multiplyScalar(r),en.setColorAt(n,Wr),e=!0}en.instanceMatrix.needsUpdate=!0,e&&(en.instanceColor.needsUpdate=!0)}function Qv(s,t){const e=new ue,n=.35+S()*.45,i=new tt({color:2777128,roughness:.7,side:kt}),o=3+Math.floor(S()*2);for(let v=0;v<o;v++){const x=v/o*6.28+S()*.3,E=new I(new Me(.08,.035),i);E.position.set(Math.cos(x)*.05,.02,Math.sin(x)*.05),E.rotation.x=-1.4,E.rotation.y=-x,e.add(E)}const r=new tt({color:G.dandStem,roughness:.8}),a=new I(new yt(.008,.012,n,4),r);a.position.y=n/2,e.add(a);const c=new K({color:14540236,transparent:!0,opacity:.3});for(let v=0;v<4;v++){const x=n*.2+v*n*.18,E=new I(new yt(.002,.001,.02,3),c);E.position.set(.01,x,0),E.rotation.z=-.8,e.add(E)}const l=new tt({color:G.fern,roughness:.7,side:kt}),h=new I(new Me(.07,.03),l);h.position.set(.03,n*.15,0),h.rotation.z=-.4,e.add(h);const u=new tt({color:G.dandHead,emissive:G.dandSeedGlow,emissiveIntensity:.2,transparent:!0,opacity:.85}),f=new I(new J(.07,6,5),u);f.position.y=n+.05,e.add(f);const m=new tt({color:15663103,emissive:11197951,emissiveIntensity:.15,transparent:!0,opacity:.5,roughness:0,metalness:.5}),g=new I(new J(.012,4,3),m);g.position.set(.04,n+.07,.03),e.add(g);const _=new K({color:G.dandSeed,transparent:!0,opacity:.7});for(let v=0;v<8;v++){const x=v/8*6.28+S()*.2,E=new I(new Xn(.015,.05,3),_);E.position.set(Math.cos(x)*.06,n+.05+S()*.04,Math.sin(x)*.06),E.rotation.x=(S()-.5)*.6,E.rotation.z=(S()-.5)*.6,e.add(E);const T=new K({color:16777215,transparent:!0,opacity:.3}),b=new I(new yt(.001,.001,.03,3),T);b.position.set(Math.cos(x)*.08,n+.08,Math.sin(x)*.08),b.rotation.set((S()-.5)*.5,0,(S()-.5)*.5),e.add(b);const A=new K({color:15658717,transparent:!0,opacity:.15});for(let w=0;w<2;w++){const M=x+(w-.5)*.5,P=new I(new yt(8e-4,8e-4,.025,3),A);P.position.set(Math.cos(M)*.075,n+.09,Math.sin(M)*.075),P.rotation.set((S()-.5)*.8,0,(S()-.5)*.8),e.add(P)}}const p=new tt({color:3811856,roughness:.9});for(let v=0;v<4;v++){const x=v/4*6.28+S()*.5,E=new I(new J(.005,3,3),p);E.scale.set(.6,1.5,.6),E.position.set(Math.cos(x)*.04,n+.04,Math.sin(x)*.04),e.add(E)}const d=new K({color:1716240,transparent:!0,opacity:.15});for(let v=0;v<3;v++){const x=v/3*6.28,E=new I(new yt(.001,.001,n*.7,3),d);E.position.set(Math.cos(x)*.01,n*.35,Math.sin(x)*.01),e.add(E)}const y=new K({color:13426107,transparent:!0,opacity:.2});for(let v=0;v<5;v++){const x=n*.1+S()*n*.7,E=S()*6.28,T=new I(new yt(8e-4,8e-4,.012,3),y);T.position.set(Math.cos(E)*.012,x,Math.sin(E)*.012),T.rotation.z=E<3.14?-.8:.8,T.rotation.y=E,e.add(T)}return e.position.set(s,0,t),vt.add(e),{group:e,headMat:u,x:s,z:t,h:n,dispersed:!1,phase:S()*6.28,seedCount:8,regrowTimer:0}}function tM(s,t,e,n){for(let i=0;i<s.length;i++){const o=s[i];if(o.dispersed){if(o.regrowTimer-=t,o.regrowTimer<=0){o.dispersed=!1;for(let r=2;r<o.group.children.length;r++)o.group.children[r].visible=!0}o.group.rotation.z=Math.sin(e*.9+o.phase)*.02}else{const r=o.x-n.x,a=o.z-n.z;if(r*r+a*a<1.2){o.dispersed=!0;for(let c=0;c<8;c++)Jv(o.x,o.h+.05,o.z);for(let c=2;c<o.group.children.length;c++)o.group.children[c].visible=!1;o.regrowTimer=15+Math.random()*10}else o.group.rotation.z=Math.sin(e*.9+o.phase)*.04,o.headMat.emissiveIntensity=.15+Math.sin(e*1.2+o.phase)*.1}}}function eM(s,t,e){const n=new ue,i=new tt({color:G.jellyBell,emissive:G.jellyGlow,emissiveIntensity:.8,transparent:!0,opacity:.5,roughness:.2,metalness:.1,side:kt}),o=new I(new J(.5,8,6,0,6.28,0,Math.PI/2),i);o.scale.set(1,.6,1),o.position.y=0,n.add(o);const r=new tt({color:G.jellyBell,emissive:G.jellyGlow,emissiveIntensity:1,transparent:!0,opacity:.6}),a=new I(new be(.48,.025,5,12),r);a.rotation.x=Math.PI/2,a.position.y=-.02,n.add(a);const c=new I(new J(.2,6,4),new K({color:G.jellyGlow,transparent:!0,opacity:.7}));c.position.y=-.05,n.add(c);const l=new K({color:12312063,transparent:!0,opacity:.3});for(let y=-1;y<=1;y+=2){const v=new I(new J(.06,4,3),l);v.scale.set(.6,1.5,.6),v.position.set(y*.08,-.03,0),n.add(v)}const h=new K({color:15663103,transparent:!0,opacity:.7});for(let y=0;y<5;y++){const v=S()*6.28,x=S()*.8,E=new I(new J(.02,3,3),h);E.position.set(Math.cos(v)*x*.35,.1-x*.15,Math.sin(v)*x*.35),n.add(E)}const u=new tt({color:G.jellyTent,emissive:G.jellyGlow,emissiveIntensity:.4,transparent:!0,opacity:.4}),f=new K({color:G.jellyGlow,transparent:!0,opacity:.6});for(let y=0;y<6;y++){const v=y/6*6.28,x=.4+S()*.6,E=new I(new yt(.015,.008,x,3),u);E.position.set(Math.cos(v)*.25,-x/2-.05,Math.sin(v)*.25),n.add(E);const T=new I(new J(.012,3,3),f);T.position.set(Math.cos(v)*.25,-x-.06,Math.sin(v)*.25),n.add(T)}const m=new K({color:G.jellyGlow,transparent:!0,opacity:.12});for(let y=0;y<8;y++){const v=y/8*6.28,x=new I(new yt(.002,.002,.4,3),m);x.position.set(Math.cos(v)*.2,.05,Math.sin(v)*.2),x.rotation.z=Math.PI/2-.3,x.rotation.y=-v,n.add(x)}const g=new tt({color:G.jellyBell,emissive:G.jellyGlow,emissiveIntensity:.6,transparent:!0,opacity:.4});for(let y=0;y<10;y++){const v=y/10*6.28,x=new I(new J(.02,3,3),g);x.scale.set(1,.5,.8),x.position.set(Math.cos(v)*.46,-.04,Math.sin(v)*.46),n.add(x)}const _=new tt({color:G.jellyTent,emissive:G.jellyGlow,emissiveIntensity:.5,transparent:!0,opacity:.35}),p=new I(new yt(.02,.01,.35,4),_);p.position.y=-.2,n.add(p);const d=new K({color:14548991,transparent:!0,opacity:.4});for(let y=0;y<3;y++){const v=y/3*6.28,x=new I(new J(.008,3,3),d);x.position.set(Math.cos(v)*.25,-.55-S()*.3,Math.sin(v)*.25),n.add(x)}return n.position.set(s,t,e),vt.add(n),{group:n,bellMat:i,phase:S()*6.28,driftAng:S()*6.28,homeX:s,homeZ:e,floatY:t,wobble:.5+S()*.5,_init:!0,_state:"drift",_stT:20+Math.random()*30,_migrateAng:0,_pulseSync:0}}function nM(s,t){const e=new ue,n=new tt({color:G.puffBody,emissive:G.puffGlow,emissiveIntensity:.3,roughness:.8}),i=new I(new J(.3,8,6),n);i.position.y=.35,e.add(i);const o=new tt({color:16773344,emissive:G.puffGlow,emissiveIntensity:.15,roughness:.9}),r=new I(new J(.18,6,4),o);r.scale.set(.7,.9,.3),r.position.set(0,.32,.2),e.add(r);const a=new I(new J(.22,7,5),n);a.position.y=.65,e.add(a);const c=[];for(let E=-1;E<=1;E+=2){const T=new I(new Xn(.06,.15,4),n);T.position.set(E*.13,.85,0),T.rotation.z=E*.3,e.add(T),c.push({mesh:T,side:E,baseRotZ:E*.3});const b=new I(new Xn(.03,.08,4),new tt({color:G.puffCheek,emissive:G.puffCheek,emissiveIntensity:.2}));b.position.set(E*.13,.84,.01),b.rotation.z=E*.3,e.add(b),c.push({mesh:b,side:E,baseRotZ:E*.3})}const l=new K({color:G.puffEye}),h=[];for(let E=-1;E<=1;E+=2){const T=new I(new J(.035,4,4),l);T.position.set(E*.09,.68,.18),e.add(T),h.push(T);const b=new K({color:16777215}),A=new I(new J(.012,3,3),b);A.position.set(E*.09+E*.015,.695,.2),e.add(A),h.push(A)}const u=new K({color:4469555}),f=new I(new J(.015,3,3),u);f.position.set(0,.63,.22),e.add(f);const m=new tt({color:G.puffCheek,emissive:G.puffCheek,emissiveIntensity:.3});for(let E=-1;E<=1;E+=2){const T=new I(new J(.04,4,3),m);T.position.set(E*.15,.61,.15),e.add(T)}const g=new K({color:15654348,transparent:!0,opacity:.5});for(let E=-1;E<=1;E+=2)for(let T=0;T<2;T++){const b=new I(new yt(.002,.002,.06,3),g);b.position.set(E*.12,.62-T*.03,.2),b.rotation.z=E*.7+T*E*.2,b.rotation.x=-.1,e.add(b)}for(let E=-1;E<=1;E+=2){const T=new I(new J(.07,4,3),n);T.position.set(E*.12,.07,.05),T.scale.set(1,.5,1.3),e.add(T);const b=new tt({color:16755370,emissive:16746632,emissiveIntensity:.1});for(let A=0;A<3;A++){const w=A/3*6.28,M=new I(new J(.012,3,3),b);M.position.set(E*.12+Math.cos(w)*.03,.03,.05+Math.sin(w)*.03),e.add(M)}}const _=new tt({color:16777215,emissive:G.puffGlow,emissiveIntensity:.4,roughness:.9}),p=new I(new J(.06,5,4),_);p.position.set(0,.38,-.28),e.add(p);const d=new tt({color:G.puffBody,emissive:G.puffGlow,emissiveIntensity:.2,roughness:1});for(let E=0;E<6;E++){const T=S()*6.28,b=S()*1.2,A=new I(new J(.01,3,3),d);A.position.set(Math.cos(T)*.28,.25+b*.2,Math.sin(T)*.28),e.add(A)}const y=new K({color:G.puffBody});for(let E=-1;E<=1;E+=2){const T=new I(new yt(.003,.003,.04,3),y);T.position.set(E*.09,.72,.17),T.rotation.z=E*.3,e.add(T)}const v=new K({color:5583684,transparent:!0,opacity:.5}),x=new I(new yt(.002,.002,.03,3),v);return x.position.set(0,.59,.22),x.rotation.z=Math.PI/2,e.add(x),e.position.set(s,0,t),vt.add(e),{group:e,ears:c,eyes:h,tail:p,phase:S()*6.28,wanderAng:S()*6.28,speed:.6+S()*.8,hopTimer:0,hopPhase:S()*6.28,homeX:s,homeZ:t,state:"idle",idleTimer:S()*3,_init:!0,_followT:0,_scaredT:0,_huddleTarget:-1,_baseY:0,_lastTX:s,_lastTZ:t,_blinkTimer:2+Math.random()*4,_blinkState:0}}function iM(s,t){const e=new ue,n=new tt({color:G.deerBody,emissive:G.deerGlow,emissiveIntensity:.5,transparent:!0,opacity:.7,roughness:.3}),i=new I(new J(.4,7,5),n);i.scale.set(1,.8,1.5),i.position.y=.9,e.add(i);const o=new tt({color:13431039,emissive:G.deerGlow,emissiveIntensity:.8,transparent:!0,opacity:.5}),r=new I(new J(.15,5,4),o);r.scale.set(.8,.6,.5),r.position.set(0,.78,.25),e.add(r);const a=new ue;a.position.set(0,1.15,.3);const c=new I(new yt(.08,.12,.4,5),n);c.position.set(0,.1,.08),c.rotation.x=-.4,a.add(c);const l=new I(new J(.14,6,5),n);l.position.set(0,.22,.2),a.add(l);const h=new I(new J(.07,4,3),n);h.scale.set(1,.7,1.4),h.position.set(0,.17,.35),a.add(h);const u=new K({color:2245717}),f=new I(new J(.02,3,3),u);f.position.set(0,.17,.43),a.add(f);const m=new K({color:G.deerEye});for(let M=-1;M<=1;M+=2){const P=new I(new J(.025,4,3),m);P.position.set(M*.09,.25,.28),a.add(P);const F=new I(new J(.008,3,3),new K({color:16777215}));F.position.set(M*.085,.26,.29),a.add(F);const U=new K({color:G.deerBody,transparent:!0,opacity:.5}),z=new I(new yt(.002,.002,.03,3),U);z.position.set(M*.1,.27,.28),z.rotation.z=M*.6,a.add(z)}for(let M=-1;M<=1;M+=2){const P=new I(new Xn(.04,.14,4),n);P.position.set(M*.1,.37,.15),P.rotation.z=M*.4,a.add(P)}const g=new tt({color:G.deerAntler,emissive:G.deerGlow,emissiveIntensity:.8,transparent:!0,opacity:.8});for(let M=-1;M<=1;M+=2){const P=new I(new yt(.015,.02,.25,3),g);P.position.set(M*.08,.42,.12),P.rotation.z=M*.5,a.add(P);const F=new I(new yt(.01,.015,.15,3),g);F.position.set(M*.15,.55,.1),F.rotation.z=M*.8,a.add(F);const U=new I(new yt(.008,.012,.1,3),g);U.position.set(M*.11,.5,.16),U.rotation.z=M*.3,U.rotation.x=-.5,a.add(U);const z=new I(new J(.012,3,3),new K({color:G.deerGlow,transparent:!0,opacity:.8}));z.position.set(M*.18,.61,.09),a.add(z)}const _=new tt({color:G.deerBody,emissive:G.deerGlow,emissiveIntensity:.3,transparent:!0,opacity:.5}),p=new I(new yt(.01,.02,.1,3),_);p.position.set(0,.11,.28),p.rotation.x=.3,a.add(p);const d=new K({color:1122850});for(let M=-1;M<=1;M+=2){const P=new I(new J(.006,3,3),d);P.position.set(M*.02,.16,.42),a.add(P)}e.add(a);const y=[{x:-.15,z:.3,label:"FL"},{x:.15,z:.3,label:"FR"},{x:-.15,z:-.3,label:"BL"},{x:.15,z:-.3,label:"BR"}],v=new tt({color:6715272,emissive:G.deerGlow,emissiveIntensity:.2,transparent:!0,opacity:.7}),x=[];for(let M=0;M<4;M++){const P=y[M],F=new ue;F.position.set(P.x,.65,P.z);const U=new I(new yt(.025,.035,.35,4),n);U.position.y=-.175,F.add(U);const z=new ue;z.position.set(0,-.35,0);const V=new I(new yt(.02,.03,.3,4),n);V.position.y=-.15,z.add(V);const H=new I(new yt(.04,.032,.04,4),v);H.position.y=-.3,z.add(H);const $=new tt({color:14544639,emissive:G.deerGlow,emissiveIntensity:.3,transparent:!0,opacity:.5}),q=new I(new J(.025,3,3),$);q.scale.set(1.3,.5,1.3),q.position.y=-.25,z.add(q),F.add(z),e.add(F),x.push({upper:F,lower:z,isFront:M<2,side:P.x<0?-1:1})}const E=new ue;E.position.set(0,1.1,-.55);const T=new I(new Xn(.05,.15,4),new tt({color:16777215,emissive:G.deerGlow,emissiveIntensity:1,transparent:!0,opacity:.8}));E.add(T),e.add(E);const b=new K({color:13434862,transparent:!0,opacity:.3});for(let M=0;M<4;M++){const P=new I(new J(.02,3,3),b);P.position.set((S()-.5)*.25,.8+S()*.3,(S()-.5)*.4),e.add(P)}const A=new K({color:G.deerBody,transparent:!0,opacity:.15});for(let M=0;M<3;M++){const P=new I(new yt(.002,.002,.2,3),A);P.position.set(.3,.85-M*.06,0),P.rotation.z=Math.PI/2+.3,e.add(P)}const w=new tt({color:15663103,emissive:11197951,emissiveIntensity:.15,transparent:!0,opacity:.4,roughness:0,metalness:.5});for(let M=0;M<3;M++){const P=new I(new J(.008,3,3),w);P.position.set((S()-.5)*.3,.9+S()*.3,(S()-.5)*.35),e.add(P)}return e.position.set(s,0,t),vt.add(e),{group:e,mat:n,phase:S()*6.28,wanderAng:S()*6.28,speed:.6+S()*.4,walkTimer:0,legCycle:0,homeX:s,homeZ:t,state:"walk",pauseTimer:0,neckPivot:a,legPivots:x,tailPivot:E,fleeTimer:0,headLook:0,headBob:0,_init:!0,_stT:0,_drinkTgt:null,_zigTimer:0,_zigDir:1,_baseY:0,_lastTX:s,_lastTZ:t}}function sM(s,t,e){const n=new ue,i=new tt({color:G.mothBody,emissive:G.mothGlow,emissiveIntensity:.3,roughness:.7}),o=new I(new yt(.04,.05,.3,5),i);o.rotation.x=Math.PI/2,n.add(o);const r=new tt({color:G.mothBody,emissive:G.mothGlow,emissiveIntensity:.5,roughness:.6});for(let p=0;p<3;p++){const d=new I(new be(.045,.006,4,8),r);d.position.z=-.05+p*.06,d.rotation.x=0,n.add(d)}const a=new I(new J(.05,5,4),i);a.position.z=.18,n.add(a);const c=new tt({color:1122867,roughness:.2,metalness:.4});for(let p=-1;p<=1;p+=2){const d=new I(new J(.018,4,3),c);d.position.set(p*.03,.01,.21),n.add(d)}for(let p=-1;p<=1;p+=2){const d=new I(new yt(.005,.005,.15,3),i);d.position.set(p*.03,.03,.22),d.rotation.x=-.6,d.rotation.z=p*.4,n.add(d);const y=new K({color:G.mothGlow,transparent:!0,opacity:.7}),v=new I(new J(.015,3,3),y);v.scale.set(2,.5,1),v.position.set(p*.05,.12,.28),n.add(v)}const l=new tt({color:G.mothWing,emissive:G.mothGlow,emissiveIntensity:.8,transparent:!0,opacity:.6,side:kt,roughness:.4});n._wingPivots=[];for(let p=-1;p<=1;p+=2){const d=new ue;d.position.set(p*.04,0,.02);const y=new I(new J(.2,6,4),l);y.scale.set(1.8,.08,1.2),y.position.set(p*.18,0,.02),d.add(y);const v=new I(new J(.12,5,3),l);v.scale.set(1.5,.06,1),v.position.set(p*.12,0,-.1),d.add(v);const x=new tt({color:G.mothWing,emissive:G.mothGlow,emissiveIntensity:.6,transparent:!0,opacity:.45,side:kt}),E=new I(new Me(.03,.12),x);E.position.set(p*.1,0,-.18),E.rotation.y=p*.2,d.add(E);const T=new K({color:G.mothSpot,transparent:!0,opacity:.9}),b=new I(new J(.03,4,3),T);b.position.set(p*.2,.02,.03),d.add(b);const A=new I(new J(.018,3,3),T);A.position.set(p*.1,.02,-.08),d.add(A);const w=new K({color:G.mothGlow,transparent:!0,opacity:.25});for(let M=0;M<2;M++){const P=new I(new yt(.002,.002,.2,3),w);P.position.set(p*.15,.01,-.02+M*.06),P.rotation.z=Math.PI/2+p*(.15+M*.15),d.add(P)}n.add(d),n._wingPivots.push({pivot:d,side:p})}const h=new K({color:G.mothGlow,transparent:!0,opacity:.25});for(let p=0;p<3;p++){const d=new I(new J(.008,3,3),h);d.position.set((S()-.5)*.04,0,-.15-p*.05),n.add(d)}const u=new K({color:4473907,transparent:!0,opacity:.5}),f=new I(new be(.015,.003,4,8,Math.PI*1.5),u);f.position.set(0,-.02,.2),f.rotation.x=.4,n.add(f);const m=new tt({color:G.mothBody,emissive:G.mothGlow,emissiveIntensity:.4,roughness:1});for(let p=0;p<5;p++){const d=S()*6.28,y=new I(new J(.008,3,3),m);y.position.set(Math.cos(d)*.04,Math.sin(d)*.04,S()*.15-.05),n.add(y)}const g=new K({color:G.mothBody,transparent:!0,opacity:.4});for(let p=-1;p<=1;p+=2)for(let d=0;d<3;d++){const y=new I(new yt(.002,.002,.06,3),g);y.position.set(p*.04,-.03,-.05+d*.06),y.rotation.z=p*.8,y.rotation.x=-.3,n.add(y)}const _=new K({color:G.mothGlow,transparent:!0,opacity:.35});for(let p=-1;p<=1;p+=2)for(let d=0;d<5;d++){const y=d/5*Math.PI-Math.PI/2,v=new I(new J(.006,3,3),_);v.position.set(p*(.3+Math.cos(y)*.05),Math.sin(y)*.02,.02+d*.04),n.add(v)}return n.position.set(s,t,e),vt.add(n),{group:n,wingMat:l,phase:S()*6.28,orbitAng:S()*6.28,orbitR:2+S()*4,centerX:s,centerZ:e,floatY:t,flapSpeed:6+S()*4,_init:!0,_state:"patrol",_stT:0,_attractTarget:null,_restTree:null}}function oM(s,t,e){const n=new ue,i=new K({color:G.wispCore}),o=new I(new J(.08,6,4),i);n.add(o);const r=new K({color:16777215,transparent:!0,opacity:.7,wireframe:!0}),a=new I(new Wi(.06,0),r);n.add(a);const c=new K({color:G.wispGlow,transparent:!0,opacity:.5}),l=new I(new J(.18,6,4),c);n.add(l);const h=new K({color:G.wispGlow,transparent:!0,opacity:.25}),u=new I(new be(.22,.008,4,12),h);u.rotation.x=Math.PI/2,n.add(u);const f=new K({color:G.wispTrail,transparent:!0,opacity:.15}),m=new I(new J(.35,5,4),f);n.add(m);const g=new K({color:16777215,transparent:!0,opacity:.8}),_=new I(new J(.02,3,3),g);_.position.set(.15,0,0),n.add(_);const p=[];for(let b=0;b<3;b++){const A=new K({color:G.wispCore,transparent:!0,opacity:.35}),w=new I(new J(.01,3,3),A);w.position.set((S()-.5)*.1,-.1-b*.08,(S()-.5)*.1),n.add(w),p.push(w)}const d=new K({color:G.wispGlow,transparent:!0,opacity:.18}),y=[];for(let b=0;b<3;b++){const A=b/3*6.28+S()*.5,w=.15+S()*.1,M=new I(new yt(.003,.001,w,3),d);M.position.set(Math.cos(A)*.1,S()*.08,Math.sin(A)*.1),M.rotation.z=Math.PI/3*(A<3.14?1:-1),M.rotation.y=A,n.add(M),y.push({mesh:M,baseAng:A})}const v=new K({color:G.wispGlow,transparent:!0,opacity:.12}),x=new I(new be(.26,.005,4,10),v);x.rotation.x=1.2,x.rotation.z=.8,n.add(x);const E=new K({color:16777215,transparent:!0,opacity:.5});for(let b=0;b<4;b++){const A=S()*6.28,w=S()*.8,M=new I(new J(.006,3,3),E);M.position.set(Math.cos(A)*.06,Math.sin(w)*.06,Math.sin(A)*.06),n.add(M)}const T=new K({color:G.wispCore,transparent:!0,opacity:.2});for(let b=0;b<4;b++){const A=new I(new J(.004,3,3),T);A.position.set(.03+S()*.04,-.05-b*.04,S()*.04),n.add(A)}return n.scale.setScalar(.5),n.position.set(s,t,e),vt.add(n),{group:n,glowMat:c,hazeMat:f,embers:p,tendrils:y,plasmaMat:d,facet:a,halo:u,halo2:x,phase:S()*6.28,targetX:s,targetY:t,targetZ:e,velX:0,velY:0,velZ:0,scatter:0}}function rM(s,t){const e=new ue,n=sl,i=8+Math.floor(S()*5),o=new tt({color:G.fairyMush,emissive:G.fairyGlow,emissiveIntensity:.2,roughness:.5}),r=new tt({color:G.mushStem,roughness:.7,emissive:G.fairyGlow,emissiveIntensity:.05});for(let E=0;E<i;E++){const T=E/i*6.28+S()*.15,b=n+S()*.3-.15,A=.15+S()*.2,w=new I(hn.mushStem,r);w.scale.setScalar(A),w.position.set(Math.cos(T)*b,A*.3,Math.sin(T)*b),e.add(w);const M=new I(hn.mushCap,o);M.scale.set(A,A*.4,A),M.position.set(Math.cos(T)*b,A*.55,Math.sin(T)*b),e.add(M);const P=new K({color:16777215,transparent:!0,opacity:.7}),F=new I(new J(A*.08,3,3),P);F.position.set(Math.cos(T)*b,A*.6,Math.sin(T)*b),e.add(F)}const a=new tt({color:8934792,emissive:G.fairyGlow,emissiveIntensity:.1,roughness:.6});for(let E=0;E<5;E++){const T=S()*6.28,b=n+S()*.6-.3,A=.06+S()*.06,w=new I(hn.mushCap,a);w.scale.set(A,A*.5,A),w.position.set(Math.cos(T)*b,A*.35,Math.sin(T)*b),e.add(w)}const c=new tt({color:1725733,emissive:664080,emissiveIntensity:.05,roughness:.9});for(let E=0;E<4;E++){const T=S()*6.28,b=S()*n*.8,A=new I(new J(.08+S()*.08,4,3),c);A.scale.set(1.5,.2,1.5),A.position.set(Math.cos(T)*b,.01,Math.sin(T)*b),e.add(A)}const l=new tt({color:4478310,emissive:G.fairyGlow,emissiveIntensity:.05,roughness:.85}),h=new I(new J(.12,5,3),l);h.scale.set(1.2,.3,1),h.position.y=.03,e.add(h);const u=new K({color:G.fairyGlow,transparent:!0,opacity:.2}),f=[];for(let E=0;E<8;E++){const T=new I(new J(.012,3,3),u),b=(S()-.5)*n*.8,A=(S()-.5)*n*.8;T.position.set(b,.05+S()*.3,A),e.add(T),f.push({mesh:T,baseX:b,baseZ:A,drift:S()*6.28,speed:.2+S()*.3})}const m=new K({color:G.fairyRing,transparent:!0,opacity:0,side:kt}),g=new I(new bo(.3,n-.3,16),m);g.rotation.x=-Math.PI/2,g.position.y=.02,e.add(g);const _=new K({color:G.fairyGlow,transparent:!0,opacity:.08});for(let E=0;E<6;E++){const T=S()*6.28,b=T+.5+S()*1.5,A=n*.6+S()*n*.4,w=new I(new yt(.002,.002,A,3),_);w.position.set(Math.cos((T+b)/2)*n*.4,.005,Math.sin((T+b)/2)*n*.4),w.rotation.x=Math.PI/2,w.rotation.z=T,e.add(w)}const p=new tt({color:4864560,roughness:.9,transparent:!0,opacity:.5});for(let E=0;E<3;E++){const T=S()*6.28,b=S()*n*.7,A=new I(new J(.03,4,3),p);A.scale.set(1.3,.3,1.3),A.position.set(Math.cos(T)*b,.008,Math.sin(T)*b),e.add(A)}const d=new tt({color:7833702,roughness:.9,transparent:!0,opacity:.5});for(let E=0;E<2;E++){const T=new I(new Fe(.02+S()*.02,4),d);T.position.set((S()-.5)*.08,.06,(S()-.5)*.06),T.rotation.x=-Math.PI/2+S()*.4,e.add(T)}const y=[];for(let E=0;E<5;E++){const T=S()*6.28,b=S()*n*.9,A=new K({color:8978346,transparent:!0,opacity:.25}),w=new I(new J(.005,3,3),A);w.position.set(Math.cos(T)*b,.01,Math.sin(T)*b),e.add(w),y.push(w)}const v=new K({color:657926,transparent:!0,opacity:.15,side:kt}),x=new I(new bo(n*.5,n*.85,12),v);return x.rotation.x=-Math.PI/2,x.position.y=.008,e.add(x),e.position.set(s,0,t),vt.add(e),{group:e,mushMat:o,discMat:m,sporeMat:u,spores:f,glowWorms:y,x:s,z:t,ringR:n,phase:S()*6.28,glowIntensity:0,active:!1}}function aM(s,t,e){const n=new ue,i=new tt({color:G.bubbleIris,emissive:G.bubbleIris,emissiveIntensity:.15,transparent:!0,opacity:.25,roughness:0,metalness:.6}),o=new I(hn.bubble,i);n.add(o);const r=new K({color:15650047,transparent:!0,opacity:.1}),a=new I(new be(.13,.003,4,10),r);a.rotation.x=.5,a.rotation.y=S()*3,n.add(a);const c=new I(new be(.11,.003,4,10),r);c.rotation.x=-.8,c.rotation.z=1.2,n.add(c);const l=new K({color:G.bubbleShine,transparent:!0,opacity:.5}),h=new I(new J(.04,4,3),l);h.position.set(.05,.07,.08),n.add(h);const u=new K({color:15658751,transparent:!0,opacity:.2}),f=new I(new J(.025,3,3),u);f.position.set(-.06,-.04,-.06),n.add(f);const m=new K({color:16755438,transparent:!0,opacity:.12}),g=new I(new J(.06,4,3),m);g.position.set(.02,-.02,.01),n.add(g);const _=new K({color:16772863,transparent:!0,opacity:.08}),p=new I(new J(.12,5,4),_);n.add(p);const d=[16764125,13426175,14548940];for(let A=0;A<3;A++){const w=new K({color:d[A],transparent:!0,opacity:.06}),M=new I(new be(.14-A*.02,.002,4,8),w);M.position.y=-.04+A*.04,M.rotation.x=Math.PI/2,n.add(M)}const y=new K({color:16777215,transparent:!0,opacity:.6});for(let A=0;A<3;A++){const w=S()*6.28,M=S()*Math.PI-Math.PI/2,P=new I(new J(.003,3,3),y);P.position.set(Math.cos(w)*Math.cos(M)*.14,Math.sin(M)*.14,Math.sin(w)*Math.cos(M)*.14),n.add(P)}const v=new K({color:11189196,transparent:!0,opacity:.1}),x=new I(new J(.015,3,3),v);x.position.set((S()-.5)*.04,(S()-.5)*.04,(S()-.5)*.04),n.add(x);const E=new K({color:G.bubbleIris,transparent:!0,opacity:.15}),T=new I(new J(.04,4,3),E);T.scale.set(1.3,.6,1.3),T.position.y=-.12,n.add(T);const b=.6+S()*.8;return n.scale.setScalar(b),n.position.set(s,t,e),vt.add(n),{group:n,shellMat:i,phase:S()*6.28,driftAng:S()*6.28,driftSpeed:.3+S()*.5,floatY:t,homeX:s,homeZ:e,bobAmp:.3+S()*.4,popped:!1,popTimer:0,sc:b}}function cM(s,t){const e=new ue,n=1.5+S()*1,i=new tt({color:329746,roughness:.9}),o=new I(new Fe(n*.85,10),i);o.rotation.x=-Math.PI/2,o.position.y=.005,e.add(o);const r=new tt({color:G.pondWater,emissive:G.pondGlow,emissiveIntensity:.2,transparent:!0,opacity:.55,roughness:.05,metalness:.4}),a=new I(new Fe(n,12),r);a.rotation.x=-Math.PI/2,a.position.y=.03,e.add(a);const c=new tt({color:3816002,roughness:.85}),l=5+Math.floor(S()*4);for(let U=0;U<l;U++){const z=U/l*6.28+S()*.3,V=n+S()*.2-.1,H=.06+S()*.08,$=new I(new J(H,4,3),c);$.scale.set(1+S()*.5,.4+S()*.3,1+S()*.5),$.position.set(Math.cos(z)*V,H*.2,Math.sin(z)*V),$.rotation.set(S(),S(),S()),e.add($)}const h=new tt({color:1725728,roughness:.7,side:kt});for(let U=0;U<3;U++){const z=S()*6.28,V=n*.85+S()*.2;for(let H=0;H<3;H++){const $=new I(new Me(.015,.15+S()*.1),h);$.position.set(Math.cos(z)*V+(S()-.5)*.05,.08,Math.sin(z)*V+(S()-.5)*.05),$.rotation.y=S()*3,$.rotation.x=-.2,e.add($)}}const u=new K({color:11197934,transparent:!0,opacity:.08}),f=[];for(let U=0;U<3;U++){const z=new I(new be(1,.004,4,20),u.clone());z.rotation.x=Math.PI/2,z.position.y=.036,e.add(z),f.push({mesh:z,phase:U/3})}const m=new tt({color:G.lilyPad,roughness:.6,side:kt}),g=4+Math.floor(S()*2),_=[];for(let U=0;U<g;U++){const z=S()*6.28,V=S()*n*.6,H=.15+S()*.15,$=new I(new Fe(H,8),m);$.rotation.x=-Math.PI/2,$.position.set(Math.cos(z)*V,.05,Math.sin(z)*V),e.add($);const q=new K({color:1724448,transparent:!0,opacity:.3}),rt=new I(new yt(.002,.002,H*1.5,3),q);rt.position.set(Math.cos(z)*V,.052,Math.sin(z)*V),rt.rotation.x=Math.PI/2,rt.rotation.z=S()*3,e.add(rt),_.push({mesh:$,phase:S()*6.28})}const p=new tt({color:G.lilyFlower,emissive:G.lilyGlow,emissiveIntensity:.4,transparent:!0,opacity:.85,side:kt}),d=.08;for(let U=0;U<6;U++){const z=U/6*6.28,V=new I(new Me(.06,.05),p);V.position.set(_[0].mesh.position.x+Math.cos(z)*.05,d,_[0].mesh.position.z+Math.sin(z)*.05),V.rotation.x=-1,V.rotation.y=-z,e.add(V)}const y=new tt({color:16777130,emissive:G.lilyGlow,emissiveIntensity:.8}),v=new I(new J(.025,4,3),y);if(v.position.set(_[0].mesh.position.x,d+.02,_[0].mesh.position.z),e.add(v),_.length>2){const U=new tt({color:G.lilyFlower,emissive:G.lilyGlow,emissiveIntensity:.2,transparent:!0,opacity:.7}),z=new I(new J(.03,5,4),U);z.scale.set(.8,1.2,.8),z.position.set(_[2].mesh.position.x,.09,_[2].mesh.position.z),e.add(z)}const x=new tt({color:3815477,roughness:.8,transparent:!0,opacity:.5});for(let U=0;U<5;U++){const z=S()*6.28,V=S()*n*.7,H=new I(new J(.02+S()*.025,4,3),x);H.scale.set(1+S()*.5,.4,1+S()*.5),H.position.set(Math.cos(z)*V,.015,Math.sin(z)*V),e.add(H)}const E=new K({color:2761752,transparent:!0,opacity:.12,side:kt});for(let U=0;U<3;U++){const z=S()*6.28,V=S()*n*.5,H=new I(new Fe(.08+S()*.06,5),E);H.rotation.x=-Math.PI/2,H.position.set(Math.cos(z)*V,.012,Math.sin(z)*V),e.add(H)}const T=new tt({color:1122837,roughness:.7,transparent:!0,opacity:.4}),b=[];for(let U=0;U<2;U++){const z=S()*6.28,V=S()*n*.4,H=new I(new J(.012,4,3),T);H.scale.set(.8,.5,1.3),H.position.set(Math.cos(z)*V,.04,Math.sin(z)*V),e.add(H);const $=new I(new yt(.002,.001,.025,3),T);$.position.set(Math.cos(z)*V-Math.cos(z)*.02,.04,Math.sin(z)*V-Math.sin(z)*.02),$.rotation.z=Math.PI/2,$.rotation.y=z,e.add($),b.push({body:H,tail:$,ang:z,orbR:.15+S()*n*.35,speed:.3+S()*.4})}const A=new K({color:2250016,transparent:!0,opacity:.1,side:kt});for(let U=0;U<3;U++){const z=S()*6.28,V=n*.7+S()*n*.25,H=new I(new Fe(.06+S()*.04,5),A);H.rotation.x=-Math.PI/2,H.position.set(Math.cos(z)*V,.032,Math.sin(z)*V),e.add(H)}const w=new K({color:13426158,transparent:!0,opacity:.06}),M=new I(new be(n-.05,.01,4,16),w);M.rotation.x=Math.PI/2,M.position.y=.035,e.add(M);const P=new tt({color:4861976,roughness:.8,side:kt,transparent:!0,opacity:.6}),F=new I(new Fe(.03,5),P);return F.rotation.x=-Math.PI/2,F.position.set((S()-.5)*n*.5,.04,(S()-.5)*n*.5),e.add(F),e.position.set(s,0,t),vt.add(e),{group:e,waterMat:r,flMat:p,pads:_,ripples:f,tadpoles:b,x:s,z:t,phase:S()*6.28,pondR:n}}function lM(s,t){const e=new ue,n=new K({color:G.orbGold}),i=new I(new J(.2,10,8),n);e.add(i);const o=new K({color:16777215}),r=new I(new J(.06,6,4),o);e.add(r);const a=new K({color:16772744,transparent:!0,opacity:.4,wireframe:!0}),c=new I(new Wi(.15,0),a);e.add(c);const l=new K({color:G.orbGlow,transparent:!0,opacity:.5}),h=new I(new J(.35,8,6),l);e.add(h);const u=new K({color:G.orbGlow,transparent:!0,opacity:.3});for(let b=0;b<8;b++){const A=b/8*6.28,w=new I(new Xn(.02,.25,3),u);w.position.set(Math.cos(A)*.3,Math.sin(A*2)*.05,Math.sin(A)*.3),w.rotation.z=-A+Math.PI/2,w.rotation.y=A,e.add(w)}const f=new K({color:G.orbInner,transparent:!0,opacity:.15}),m=new I(new J(.6,8,5),f);e.add(m);for(let b=0;b<6;b++){const A=new I(new J(.03,4,3),new K({color:16777215})),w=b/6*6.28;A.position.set(Math.cos(w)*.4,Math.sin(w*2)*.1,Math.sin(w)*.4),e.add(A)}const g=new K({color:G.orbGold,transparent:!0,opacity:.7});for(let b=0;b<4;b++){const A=b/4*6.28+.4,w=new I(new J(.015,3,3),g);w.position.set(Math.cos(A)*.5,0,Math.sin(A)*.5),e.add(w)}const _=new K({color:16768426,transparent:!0,opacity:.12});for(let b=0;b<3;b++){const A=new I(new be(.28,.003,4,12),_);A.rotation.set(b*1.05,b*.7,0),e.add(A)}const p=new K({color:G.orbGlow,transparent:!0,opacity:.08}),d=new I(new be(.4,.004,4,16),p);d.rotation.x=Math.PI/2,e.add(d);const y=new K({color:16772812,transparent:!0,opacity:.15}),v=new I(new be(.25,.012,4,10),y);v.rotation.x=Math.PI/2,e.add(v);const x=new K({color:16777215,transparent:!0,opacity:.5});for(let b=0;b<6;b++){const A=S()*6.28,w=S()*Math.PI-Math.PI/2,M=new I(new J(.008,3,3),x);M.position.set(Math.cos(A)*Math.cos(w)*.2,Math.sin(w)*.2,Math.sin(A)*Math.cos(w)*.2),e.add(M)}const E=new K({color:G.orbGlow,transparent:!0,opacity:.1,side:kt}),T=new I(new Fe(.5,8),E);return T.rotation.x=-Math.PI/2,T.position.y=-.95,e.add(T),e.position.set(s,1,t),vt.add(e),{group:e,coreMat:n,glowMat:l,hazeMat:f,x:s,z:t,found:!1,flyUp:!1,flyY:1,phase:S()*6.28,laserLine:null,laserMat:null}}function hM(s,t){const e=new ue,n=new tt({color:G.rockBase,roughness:.85,metalness:.05}),i=new tt({color:G.rockLight,roughness:.8,metalness:.05}),o=new tt({color:G.rockMoss,emissive:G.rockMoss,emissiveIntensity:.03,roughness:.9}),r=.3+S()*.5,a=new I(new J(r,8,6),S()<.6?n:i);a.scale.set(1+S()*.6,.4+S()*.4,1+S()*.6),a.position.y=r*.2,a.rotation.set(S()*.5,S()*3,S()*.3),a.castShadow=!0,a.receiveShadow=!0,e.add(a);const c=1+Math.floor(S()*3);for(let E=0;E<c;E++){const T=S()*6.28,b=r*.6+S()*r*.5,A=r*.3+S()*r*.4,w=new I(new J(A,5,4),S()<.5?n:i);w.scale.set(1+S()*.5,.3+S()*.4,1+S()*.5),w.position.set(Math.cos(T)*b,A*.15,Math.sin(T)*b),w.rotation.set(S()*.8,S()*3,S()*.5),e.add(w)}const l=2+Math.floor(S()*3);for(let E=0;E<l;E++){const T=S()*6.28,b=S()*r*.6,A=r*.15+S()*r*.2,w=new I(new J(A,4,3),o);w.scale.set(1.5,.2,1.5),w.position.set(Math.cos(T)*b,r*.35+S()*.05,Math.sin(T)*b),e.add(w)}const h=[8943428,10061909,6715221,11180390];for(let E=0;E<3;E++){const T=new tt({color:h[Math.floor(S()*h.length)],roughness:.9,transparent:!0,opacity:.5}),b=S()*6.28,A=new I(new J(r*.06+S()*r*.08,3,3),T);A.scale.set(2,.15,2),A.position.set(Math.cos(b)*r*.5,r*.25+S()*.1,Math.sin(b)*r*.5),e.add(A)}const u=new K({color:1381656,transparent:!0,opacity:.35}),f=2+Math.floor(S()*3);for(let E=0;E<f;E++){const T=S()*6.28,b=r*.3+S()*r*.4,A=new I(new yt(.003,.001,b,3),u),w=r*.3+S()*r*.2;A.position.set(Math.cos(T)*w,r*.2+S()*r*.15,Math.sin(T)*w),A.rotation.set(S()*.5,T,Math.PI/2+S()*.4),e.add(A)}const m=new K({color:660752,transparent:!0,opacity:.2,side:kt}),g=1+Math.floor(S()*2);for(let E=0;E<g;E++){const T=S()*6.28,b=r*.3+S()*r*.3,A=new I(new Me(.02+S()*.015,b),m);A.position.set(Math.cos(T)*r*.45,r*.15,Math.sin(T)*r*.45),A.rotation.y=-T,e.add(A)}const _=[],p=new K({color:8965375,transparent:!0,opacity:.4});if(S()<.5){const E=2+Math.floor(S()*3);for(let T=0;T<E;T++){const b=S()*6.28,A=r*.25+S()*r*.25,w=new I(new J(.006,3,3),p);w.position.set(Math.cos(b)*A,r*.15+S()*r*.2,Math.sin(b)*A),e.add(w),_.push(w)}}const d=new K({color:657926,transparent:!0,opacity:.12,side:kt}),y=new I(new bo(r*.5,r*1,8),d);y.rotation.x=-Math.PI/2,y.position.y=.005,e.add(y);const v=new tt({color:3816e3,roughness:.9}),x=4+Math.floor(S()*3);for(let E=0;E<x;E++){const T=S()*6.28,b=r*.5+S()*r*.6,A=.03+S()*.05,w=new I(new J(A,3,3),v);w.scale.set(1+S()*.5,.4,1+S()*.5),w.position.set(Math.cos(T)*b,A*.15,Math.sin(T)*b),e.add(w)}if(S()<.6){const E=new tt({color:3385941,emissive:G.grassTip,emissiveIntensity:.05,roughness:.7,side:kt});for(let T=0;T<3;T++){const b=S()*6.28,A=new I(new Me(.015,.08+S()*.06),E);A.position.set(Math.cos(b)*r*.3,r*.3,Math.sin(b)*r*.3),A.rotation.y=S()*3,A.rotation.x=-.2-S()*.3,e.add(A)}}return e.position.set(s,0,t),vt.add(e),{group:e,x:s,z:t,colR:r*.8,sparkles:_,sparkleMat:p}}let zf=null,Bf=null,kf=null;function uM(){return zf}function fM(){return Bf}function dM(){return kf}function pM(){const s=new ue,t=new tt({color:G.obeliskBlack,roughness:.2,metalness:.8,emissive:G.obeliskPink,emissiveIntensity:0});Bf=t;const e=new I(new yt(1.2,1.8,Ne,4),t);e.position.y=Ne/2,e.rotation.y=Math.PI/4,e.castShadow=!0,s.add(e);const n=new K({color:3351108,transparent:!0,opacity:.2});for(let y=0;y<4;y++){const v=y/4*6.28+Math.PI/4,x=new I(new yt(.03,.04,Ne*.9,3),n);x.position.set(Math.cos(v)*1.55,Ne*.45,Math.sin(v)*1.55),s.add(x)}const i=new K({color:G.obeliskPink,transparent:!0,opacity:0});for(let y=0;y<4;y++){const v=y/4*6.28+Math.PI/4;for(let E=0;E<3;E++){const T=6+E*4,b=new I(new yt(.015,.015,.8,3),i);b.position.set(Math.cos(v)*1.6,T,Math.sin(v)*1.6),b.rotation.z=Math.PI/2,b.rotation.y=-v,b.visible=!1,s.add(b)}const x=new I(new yt(.012,.012,2.5,3),i);x.position.set(Math.cos(v)*1.6,12,Math.sin(v)*1.6),x.visible=!1,s.add(x)}const o=new tt({color:G.obeliskBlack,roughness:.1,metalness:.9,emissive:G.obeliskPink,emissiveIntensity:0});kf=o;const r=new I(new Xn(1.3,3,4),o);r.position.y=Ne+1.5,r.rotation.y=Math.PI/4,s.add(r);const a=new K({color:G.obeliskPink,transparent:!0,opacity:0});for(let y=0;y<4;y++){const v=y/4*6.28+Math.PI/4,x=new I(new yt(.02,.02,3.2,3),a);x.position.set(Math.cos(v)*.8,Ne+1.5,Math.sin(v)*.8),x.rotation.z=.35*(v<3.14?1:-1),x.rotation.y=-v,x.visible=!1,s.add(x)}for(let y=0;y<5;y++){const v=new I(new be(1.85-y*.02,.04,6,4),new K({color:2236979}));v.position.y=4+y*5,v.rotation.x=Math.PI/2,s.add(v)}const c=new tt({color:1118488,roughness:.3,metalness:.7}),l=new I(new yt(2.2,2.5,.6,4),c);l.position.y=.3,l.rotation.y=Math.PI/4,s.add(l);const h=new I(new yt(2.8,3,.4,4),c);h.position.y=.05,h.rotation.y=Math.PI/4,s.add(h);const u=new K({color:G.obeliskPink,transparent:!0,opacity:0});for(let y=0;y<8;y++){const v=y/8*6.28,x=new I(new J(.06,4,3),u);x.position.set(Math.cos(v)*2.5,Ne*.7+y*.5,Math.sin(v)*2.5),x.visible=!1,s.add(x)}const f=new K({color:1710626,transparent:!0,opacity:.08});for(let y=0;y<6;y++){const v=S()*6.28,x=2+S()*Ne*.7,E=new I(new yt(.008,.008,.5+S()*.5,3),f);E.position.set(Math.cos(v)*1.6,x,Math.sin(v)*1.6),E.rotation.z=(S()-.5)*.8,E.rotation.y=-v,s.add(E)}const m=new tt({color:921108,roughness:.5,metalness:.4});for(let y=0;y<12;y++){const v=S()*6.28,x=3+S()*2,E=.15+S()*.25,T=new I(new J(E,4,3),m);T.scale.set(1+S()*.5,.3+S()*.3,1+S()*.5),T.position.set(Math.cos(v)*x,E*.15,Math.sin(v)*x),T.rotation.set(S(),S(),S()),s.add(T)}const g=new K({color:G.obeliskPink,transparent:!0,opacity:0});for(let y=0;y<4;y++){const v=y/4*6.28+Math.PI/4;for(let x=0;x<5;x++){const E=5+x*3.5+S()*.5,T=(S()-.5)*.4,b=new I(new J(.04,4,3),g);b.position.set(Math.cos(v)*1.58+Math.cos(v+1.57)*T,E,Math.sin(v)*1.58+Math.sin(v+1.57)*T),b.visible=!1,s.add(b)}}const _=new K({color:0,transparent:!0,opacity:.15,side:kt}),p=new I(new Fe(4,8),_);p.rotation.x=-Math.PI/2,p.position.y=.005,s.add(p),s.position.set(0,-Ne,0),vt.add(s),zf=s;const d=new ji(8939212,0,30);s.add(d),d.position.set(0,Ne+1,0)}let Gf=null,Hf=null;function mM(){return Gf}function gM(){return Hf}function _M(){const s=new tt({color:G.moatBlue,emissive:1136042,emissiveIntensity:.3,transparent:!0,opacity:0,roughness:.1,metalness:.3});Hf=s;const t=new tl;t.absarc(0,0,6,0,6.28,!1);const e=new Or;e.absarc(0,0,3,0,6.28,!0),t.holes.push(e);const n=new zr(t,24),i=new I(n,s);i.rotation.x=-Math.PI/2,i.position.y=.05,i.visible=!1,vt.add(i),Gf=i;const o=new K({color:4491468,transparent:!0,opacity:0});for(let m=0;m<12;m++){const g=m/12*6.28+S()*.3,_=3.5+S()*2,p=new I(new J(.04+S()*.04,4,3),o);p.scale.set(1.2,.4,1.2),p.position.set(Math.cos(g)*_,.02,Math.sin(g)*_),p.visible=!1,vt.add(p)}const r=new K({color:13426158,transparent:!0,opacity:0,side:kt});for(let m=0;m<6;m++){const g=m/6*6.28+S()*.5,_=new I(new Fe(.12+S()*.1,5),r);_.rotation.x=-Math.PI/2,_.position.set(Math.cos(g)*3.3,.06,Math.sin(g)*3.3),_.visible=!1,vt.add(_)}const a=new K({color:8960989,transparent:!0,opacity:0});for(let m=0;m<8;m++){const g=m/8*6.28,_=4+S()*1.5,p=new I(new yt(.003,.003,.4,3),a);p.position.set(Math.cos(g)*_,.055,Math.sin(g)*_),p.rotation.x=Math.PI/2,p.rotation.z=g+Math.PI/2,p.visible=!1,vt.add(p)}const c=new K({color:264208,transparent:!0,opacity:0,side:kt}),l=new tl;l.absarc(0,0,5.2,0,6.28,!1);const h=new Or;h.absarc(0,0,3.8,0,6.28,!0),l.holes.push(h);const u=new zr(l,16),f=new I(u,c);f.rotation.x=-Math.PI/2,f.position.y=.04,f.visible=!1,vt.add(f)}const ml=[];function xM(){for(let r=0;r<6;r++){const a=G.rainbow[r],c=r/6*6.28,l=5+r*.5,h=Ne+5+r*2,u=[];for(let T=0;T<=12;T++){const b=T/12,A=c+b*Math.PI,w=Math.cos(A)*l,M=Math.sin(A)*l,P=Math.sin(b*Math.PI)*h;u.push(new D(w,P,M))}const f=new jc(u),m=new K({color:a,transparent:!0,opacity:0}),g=new Us(f,20,.12-r*.008,5,!1),_=new I(g,m);_.visible=!1,vt.add(_);const p=new K({color:a,transparent:!0,opacity:0});for(let T=0;T<5;T++){const b=(T+.5)/5,A=f.getPoint(b),w=new I(new J(.05,3,3),p);w.position.copy(A),w.visible=!1,vt.add(w)}const d=new K({color:a,transparent:!0,opacity:0,side:kt}),y=u[0],v=u[u.length-1],x=new I(new Fe(.5,6),d);x.rotation.x=-Math.PI/2,x.position.set(y.x,.03,y.z),x.visible=!1,vt.add(x);const E=new I(new Fe(.5,6),d);E.rotation.x=-Math.PI/2,E.position.set(v.x,.03,v.z),E.visible=!1,vt.add(E),ml.push({mesh:_,mat:m,targetOpacity:0})}const s=[],t=9.5,e=Ne+12;for(let r=0;r<=12;r++){const a=r/12,c=a*Math.PI;s.push(new D(Math.cos(c)*t,Math.sin(a*Math.PI)*e,Math.sin(c)*t))}const n=new jc(s),i=new K({color:15654399,transparent:!0,opacity:0}),o=new I(new Us(n,16,.04,4,!1),i);o.visible=!1,vt.add(o),ml.push({mesh:o,mat:i,targetOpacity:0})}let nn=null;const zn=[],Xe=new _e,vo=new lt;function vM(s){const t=new K({color:16777215,transparent:!0,opacity:1});nn=new Hs(hn.fly,t,s),nn.instanceMatrix.setUsage(vn),nn.instanceColor=new yi(new Float32Array(s*3),3),nn.instanceColor.setUsage(vn),Xe.scale.setScalar(0),Xe.updateMatrix();for(let e=0;e<s;e++){nn.setMatrixAt(e,Xe.matrix);const n=e%3===0?G.fireflyB:G.firefly;vo.setHex(n),nn.setColorAt(e,vo),zn.push({x:0,y:0,z:0,vx:0,vy:0,vz:0,life:0,max:0,active:!1,phase:Math.random()*6.28,wander:Math.random()*6.28,colorHex:n})}nn.count=s,vt.add(nn)}function gl(s,t,e,n){let i=null;for(let o=0;o<zn.length;o++)if(!zn[o].active){i=zn[o];break}if(!i){let o=1/0;for(let r=0;r<zn.length;r++)zn[r].life<o&&(o=zn[r].life,i=zn[r])}i.x=s,i.y=t+.5+Math.random()*3,i.z=e,i.vx=(Math.random()-.5)*2,i.vy=Math.random()-.5,i.vz=(Math.random()-.5)*2,i.life=n,i.max=n,i.active=!0,i.wander=Math.random()*6.28}function Vf(s,t){let e=0,n=!1;for(let i=0;i<zn.length;i++){const o=zn[i];if(!o.active){Xe.position.set(0,-100,0),Xe.scale.setScalar(0),Xe.updateMatrix(),nn.setMatrixAt(i,Xe.matrix);continue}if(o.life-=s,o.life<=0){o.active=!1,Xe.position.set(0,-100,0),Xe.scale.setScalar(0),Xe.updateMatrix(),nn.setMatrixAt(i,Xe.matrix);continue}e++,o.wander+=(Math.random()-.5)*3*s,o.vx+=Math.cos(o.wander)*1.5*s,o.vz+=Math.sin(o.wander)*1.5*s,o.vy+=Math.sin(t*2+o.phase)*s,o.vx*=.995,o.vy*=.995,o.vz*=.995,o.x+=o.vx*s,o.y+=o.vy*s,o.z+=o.vz*s;const r=ie(o.x,o.z)+.3;o.y<r&&(o.y=r,o.vy=Math.abs(o.vy)*.5),o.y>12&&(o.vy-=2*s);const a=Math.sin(t*3+o.phase)*.5+.5,l=o.life/o.max*(.4+a*.6),h=.6+a*.6;Xe.position.set(o.x,o.y,o.z),Xe.scale.setScalar(h),Xe.updateMatrix(),nn.setMatrixAt(i,Xe.matrix),vo.setHex(o.colorHex),vo.multiplyScalar(l),nn.setColorAt(i,vo),n=!0}return nn.instanceMatrix.needsUpdate=!0,n&&(nn.instanceColor.needsUpdate=!0),e}let sn=null;const Bn=[],Ye=new _e,Xr=new lt,MM=new lt(G.spore);function yM(s){const t=new K({color:16777215,transparent:!0,opacity:1});sn=new Hs(hn.spore,t,s),sn.instanceMatrix.setUsage(vn),sn.instanceColor=new yi(new Float32Array(s*3),3),sn.instanceColor.setUsage(vn),Ye.scale.setScalar(0),Ye.updateMatrix();for(let e=0;e<s;e++)sn.setMatrixAt(e,Ye.matrix),Xr.setHex(G.spore),sn.setColorAt(e,Xr),Bn.push({x:0,y:0,z:0,vx:0,vy:0,vz:0,life:0,max:0,active:!1});sn.count=s,vt.add(sn)}function wM(s,t,e){let n=null;for(let i=0;i<Bn.length;i++)if(!Bn[i].active){n=Bn[i];break}if(!n){let i=1/0;for(let o=0;o<Bn.length;o++)Bn[o].life<i&&(i=Bn[o].life,n=Bn[o])}n.x=s,n.y=t,n.z=e,n.vx=(Math.random()-.5)*.3,n.vy=.4+Math.random()*.4,n.vz=(Math.random()-.5)*.3,n.life=3+Math.random()*3,n.max=n.life,n.active=!0}function SM(s){let t=0,e=!1;for(let n=0;n<Bn.length;n++){const i=Bn[n];if(!i.active){Ye.position.set(0,-100,0),Ye.scale.setScalar(0),Ye.updateMatrix(),sn.setMatrixAt(n,Ye.matrix);continue}if(i.life-=s,i.life<=0){i.active=!1,Ye.position.set(0,-100,0),Ye.scale.setScalar(0),Ye.updateMatrix(),sn.setMatrixAt(n,Ye.matrix);continue}t++,i.vy+=.3*s,i.vx*=.997,i.vy*=.997,i.vz*=.997,i.x+=i.vx*s,i.y+=i.vy*s,i.z+=i.vz*s;const o=i.life/i.max*.7;Ye.position.set(i.x,i.y,i.z),Ye.scale.setScalar(1),Ye.updateMatrix(),sn.setMatrixAt(n,Ye.matrix),Xr.copy(MM).multiplyScalar(o),sn.setColorAt(n,Xr),e=!0}return sn.instanceMatrix.needsUpdate=!0,e&&(sn.instanceColor.needsUpdate=!0),t}let on=null;const bs=[];let Ka=0;const qe=new _e,Yr=new lt,Wf=new lt(G.starMote);function bM(s){const t=new K({color:16777215,transparent:!0,opacity:1});on=new Hs(hn.starMote,t,s),on.instanceMatrix.setUsage(vn),on.instanceColor=new yi(new Float32Array(s*3),3),on.instanceColor.setUsage(vn),qe.scale.setScalar(0),qe.updateMatrix();for(let e=0;e<s;e++)on.setMatrixAt(e,qe.matrix),Yr.copy(Wf),on.setColorAt(e,Yr),bs.push({x:0,y:0,z:0,life:0,max:0,active:!1,vy:0,drift:0});on.count=s,vt.add(on)}function EM(s){let t=null;for(let e=0;e<bs.length;e++)if(!bs[e].active){t=bs[e];break}t&&(t.x=s.x+(Math.random()-.5)*60,t.z=s.z+(Math.random()-.5)*60,t.y=15+Math.random()*20,t.life=6+Math.random()*6,t.max=t.life,t.active=!0,t.vy=-.15-Math.random()*.3,t.drift=Math.random()*6.28)}function Xf(s,t,e){Ka+=s,Ka>.15&&(Ka=0,EM(e));let n=!1;for(let i=0;i<bs.length;i++){const o=bs[i];if(!o.active){qe.position.set(0,-100,0),qe.scale.setScalar(0),qe.updateMatrix(),on.setMatrixAt(i,qe.matrix);continue}if(o.life-=s,o.life<=0||o.y<.5){o.active=!1,qe.position.set(0,-100,0),qe.scale.setScalar(0),qe.updateMatrix(),on.setMatrixAt(i,qe.matrix);continue}o.y+=o.vy*s,o.drift+=(Math.random()-.5)*.5*s,o.x+=Math.sin(o.drift)*.1*s,o.z+=Math.cos(o.drift)*.08*s;const r=o.life/o.max,a=Math.sin(t*4+i)*.3+.7,c=r*a*.7,l=.5+a*.5;qe.position.set(o.x,o.y,o.z),qe.scale.setScalar(l),qe.updateMatrix(),on.setMatrixAt(i,qe.matrix),Yr.copy(Wf).multiplyScalar(c),on.setColorAt(i,Yr),n=!0}on.instanceMatrix.needsUpdate=!0,n&&(on.instanceColor.needsUpdate=!0)}let rn=null;const Es=[],Ze=new _e,qr=new lt,Yf=new lt(8956535);function TM(s){const t=new K({color:16777215,transparent:!0,opacity:1});rn=new Hs(hn.dustMote,t,s),rn.instanceMatrix.setUsage(vn),rn.instanceColor=new yi(new Float32Array(s*3),3),rn.instanceColor.setUsage(vn),Ze.scale.setScalar(0),Ze.updateMatrix();for(let e=0;e<s;e++)rn.setMatrixAt(e,Ze.matrix),qr.copy(Yf),rn.setColorAt(e,qr),Es.push({x:0,y:0,z:0,vx:0,vy:0,vz:0,life:0,max:0,active:!1});rn.count=s,vt.add(rn)}function AM(s,t,e){for(let n=0;n<e;n++){let i=null;for(let a=0;a<Es.length;a++)if(!Es[a].active){i=Es[a];break}if(!i)continue;const o=Math.random()*6.28,r=1+Math.random()*2;i.x=s+Math.cos(o)*.2,i.y=ie(s,t)+.1,i.z=t+Math.sin(o)*.2,i.vx=Math.cos(o)*r,i.vy=.5+Math.random()*1.5,i.vz=Math.sin(o)*r,i.life=.6+Math.random()*.6,i.max=i.life,i.active=!0}}function CM(s){let t=!1;for(let e=0;e<Es.length;e++){const n=Es[e];if(!n.active){Ze.position.set(0,-100,0),Ze.scale.setScalar(0),Ze.updateMatrix(),rn.setMatrixAt(e,Ze.matrix);continue}if(n.life-=s,n.life<=0){n.active=!1,Ze.position.set(0,-100,0),Ze.scale.setScalar(0),Ze.updateMatrix(),rn.setMatrixAt(e,Ze.matrix);continue}n.vy-=3*s,n.vx*=.96,n.vy*=.96,n.vz*=.96,n.x+=n.vx*s,n.y+=n.vy*s,n.z+=n.vz*s;const i=ie(n.x,n.z)+.05;n.y<i&&(n.y=i,n.vy=0,n.vx*=.8,n.vz*=.8);const o=n.life/n.max*.4;Ze.position.set(n.x,n.y,n.z),Ze.scale.setScalar(1),Ze.updateMatrix(),rn.setMatrixAt(e,Ze.matrix),qr.copy(Yf).multiplyScalar(o),rn.setColorAt(e,qr),t=!0}rn.instanceMatrix.needsUpdate=!0,t&&(rn.instanceColor.needsUpdate=!0)}let an=null;const Ts=[],$e=new _e,Zr=new lt,qf=new lt(G.bubblePop),RM=new J(.02,3,3);function PM(s){const t=new K({color:16777215,transparent:!0,opacity:1});an=new Hs(RM,t,s),an.instanceMatrix.setUsage(vn),an.instanceColor=new yi(new Float32Array(s*3),3),an.instanceColor.setUsage(vn),$e.scale.setScalar(0),$e.updateMatrix();for(let e=0;e<s;e++)an.setMatrixAt(e,$e.matrix),Zr.copy(qf),an.setColorAt(e,Zr),Ts.push({x:0,y:0,z:0,vx:0,vy:0,vz:0,life:0,max:0,active:!1});an.count=s,vt.add(an)}function IM(s,t,e,n){for(let i=0;i<n;i++){let o=null;for(let l=0;l<Ts.length;l++)if(!Ts[l].active){o=Ts[l];break}if(!o)continue;const r=Math.random()*6.28,a=Math.random()*3.14,c=1+Math.random()*2;o.x=s,o.y=t,o.z=e,o.vx=Math.cos(r)*Math.sin(a)*c,o.vy=Math.cos(a)*c,o.vz=Math.sin(r)*Math.sin(a)*c,o.life=.4+Math.random()*.4,o.max=o.life,o.active=!0}}function LM(s){let t=!1;for(let e=0;e<Ts.length;e++){const n=Ts[e];if(!n.active){$e.position.set(0,-100,0),$e.scale.setScalar(0),$e.updateMatrix(),an.setMatrixAt(e,$e.matrix);continue}if(n.life-=s,n.life<=0){n.active=!1,$e.position.set(0,-100,0),$e.scale.setScalar(0),$e.updateMatrix(),an.setMatrixAt(e,$e.matrix);continue}n.vy-=2*s,n.vx*=.97,n.vy*=.97,n.vz*=.97,n.x+=n.vx*s,n.y+=n.vy*s,n.z+=n.vz*s;const i=n.life/n.max*.8;$e.position.set(n.x,n.y,n.z),$e.scale.setScalar(1),$e.updateMatrix(),an.setMatrixAt(e,$e.matrix),Zr.copy(qf).multiplyScalar(i),an.setColorAt(e,Zr),t=!0}an.instanceMatrix.needsUpdate=!0,t&&(an.instanceColor.needsUpdate=!0)}let Ja=0,bn="SEEK",Pi=-Ne,On=0,Ni=[],Fi=null,ao=null,co=null,Oi=null,_l=null,ti=[],lo=null,Zf=null,$f=null,xl=[],vl=[],Ml=[],yl=[];function DM(s){Ni=s.orbs,Fi=s.obeliskGroup,ao=s.obeliskMat,co=s.obeliskGlowMat,Oi=s.moatMesh,_l=s.moatMat,ti=s.rainbowArcs,lo=s.player,Zf=s.makeLaser,$f=s.orbHudEl,xl=s.deers||[],vl=s.puffs||[],Ml=s.jellies||[],yl=s.moths||[]}function UM(s,t){let e=null,n=1/0;for(let i=0;i<Ni.length;i++){const o=Ni[i];if(o.found)continue;const r=o.x-lo.pos.x,a=o.z-lo.pos.z,c=r*r+a*a;c<n&&(n=c,e=o)}if(e&&n<Xa*Xa){const i=Math.sin(t*2+e.phase)*.5+.5;ro.position.set(e.x,1,e.z),ro.intensity=1+i*2,ro.distance=Xa}else ro.intensity=0;for(let i=0;i<Ni.length;i++){const o=Ni[i];if(!(o.found&&!o.flyUp)){if(!o.found){const r=Math.sin(t*1.5+o.phase)*.5+.5;o.group.position.y=o.flyY+Math.sin(t*.8+o.phase)*.3,o.glowMat.opacity=.3+r*.4,o.hazeMat.opacity=.08+r*.12;for(let l=3;l<o.group.children.length;l++){const h=o.group.children[l],u=(l-3)/6*6.28+t*1.5;h.position.x=Math.cos(u)*.4,h.position.z=Math.sin(u)*.4,h.position.y=Math.sin(u*2+t)*.1}const a=o.x-lo.pos.x,c=o.z-lo.pos.z;if(a*a+c*c<vu*vu){o.found=!0,o.flyUp=!0,o.flyY=o.group.position.y,Ja++;const l=$f||document.getElementById("orb-hud");l&&(l.innerHTML="✦ "+Ja+" / "+ol),bn==="SEEK"&&(bn="RISING")}}if(o.flyUp){const r=Ne+5;o.flyY+=(r-o.flyY)*s*.8,o.group.position.y=o.flyY;const a=Math.min((o.flyY-1)/(r-1),1);o.group.scale.setScalar(1-a*.6),o.glowMat.opacity=.8-a*.5,o.flyY>r-1&&!o.laserLine&&(o.flyUp=!1,o.group.visible=!1,o.laserLine=Zf(o.x,o.z,r))}}}if(bn==="RISING"&&(Pi<0&&(Pi+=dv*s,Pi>0&&(Pi=0),Fi&&(Fi.position.y=Pi)),Ja>=ol&&Pi>=0&&(bn="COMPLETE",On=0)),Fi){Fi.rotation.y+=s*.03;const i=Fi.children[Fi.children.length-1];if(i&&i.isLight){const o=Math.max(0,Math.min(1,(Pi+Ne)/Ne));i.intensity=o*1.5*(.8+Math.sin(t*1.5)*.2)}}for(let i=0;i<Ni.length;i++){const o=Ni[i];if(!o.laserLine)continue;const r=Math.sin(t*3+i)*.5+.5;o.laserLine.mat.opacity=.5+r*.4,o.laserLine.glowMat.opacity=.15+r*.15}if(bn==="COMPLETE"){On+=s;const i=Math.min(On/3,1);if(ao&&(ao.emissiveIntensity=i*1.5),co&&(co.emissiveIntensity=i*2.5),On>1&&_l){const o=Math.min((On-1)/4,1);_l.opacity=o*.6,Oi&&(Oi.visible||(Oi.visible=!0),Oi.position.y=.05+Math.sin(t*3)*.02*o)}if(On>2)for(let o=0;o<ti.length;o++){const r=o*.3,a=Math.min(Math.max((On-2-r)/2,0),1);a>0&&!ti[o].mesh.visible&&(ti[o].mesh.visible=!0),ti[o].mat.opacity=a*.55,ti[o].mesh.rotation.y+=s*.1*(o+1)*.3}if(On>1){const o=Math.min((On-1)/6,1)*2;for(let r=0;r<xl.length;r++){const a=xl[r],c=a.group,l=-c.position.x,h=-c.position.z,u=Math.sqrt(l*l+h*h);u>8?(a.wanderAng=Math.atan2(-c.position.x,-c.position.z),a.state="walk",a.speed=1.5*o,c.position.x+=l/u*a.speed*s,c.position.z+=h/u*a.speed*s,c.rotation.y=a.wanderAng):a.state="pause"}for(let r=0;r<vl.length;r++){const a=vl[r],c=a.group,l=-c.position.x,h=-c.position.z,u=Math.sqrt(l*l+h*h);u>8&&(a.wanderAng=Math.atan2(-c.position.x,-c.position.z),a.state="hop",a.hopTimer=a.hopTimer%1.2,c.position.x+=l/u*1.5*o*s,c.position.z+=h/u*1.5*o*s)}for(let r=0;r<Ml.length;r++){const a=Ml[r],c=a.group;c.position.x+=(0-c.position.x)*s*.15*o,c.position.z+=(0-c.position.z)*s*.15*o}for(let r=0;r<yl.length;r++){const a=yl[r];a.centerX+=(0-a.centerX)*s*.2*o,a.centerZ+=(0-a.centerZ)*s*.2*o,a.orbitR=Math.max(a.orbitR-s*.3*o,2)}}On>10&&(bn="FINALE")}if(bn==="FINALE"){ao&&(ao.emissiveIntensity=1.5+Math.sin(t*.5)*.3),co&&(co.emissiveIntensity=2.5+Math.sin(t*.7)*.5),Oi&&(Oi.position.y=.05+Math.sin(t*3)*.02);for(let i=0;i<ti.length;i++)ti[i].mesh.rotation.y+=s*.1*(i+1)*.3,ti[i].mat.opacity=.45+Math.sin(t+i)*.1}}function NM(s,t,e){const n=Ne+2,i=[new D(s,e,t),new D(0,n,0)],o=new K({color:G.laserPink,transparent:!0,opacity:.8}),r=new uf(i[0],i[1]),a=new Us(r,1,.08,6,!1),c=new I(a,o);vt.add(c);const l=new K({color:G.laserGlow,transparent:!0,opacity:.25}),h=new I(new Us(r,1,.25,6,!1),l);return vt.add(h),{tube:c,glow:h,mat:o,glowMat:l}}const FM=600;let fr=.25,Ae=1,Au=.85,Kf="NIGHT",ho=null,uo=null,wl=null,fo=null,Er=null;const Cu=[{label:"DUSK",sky:new lt(923685),fog:new lt(791584),fogDensity:.009,moonInt:.6,moonCol:new lt(14527112),moonElev:15,ambSky:new lt(4469589),ambGnd:new lt(2238488),ambInt:.6,stars:.4,bio:.7,plRange:16,plInt:.5},{label:"NIGHT",sky:new lt(330264),fog:new lt(528408),fogDensity:.01,moonInt:1,moonCol:new lt(12307694),moonElev:55,ambSky:new lt(3359846),ambGnd:new lt(1587232),ambInt:.7,stars:.85,bio:1,plRange:18,plInt:.55},{label:"DEEP_NIGHT",sky:new lt(198160),fog:new lt(397332),fogDensity:.012,moonInt:.55,moonCol:new lt(8952251),moonElev:75,ambSky:new lt(1712708),ambGnd:new lt(1188888),ambInt:.5,stars:1,bio:1.5,plRange:22,plInt:.7},{label:"DAWN",sky:new lt(1187888),fog:new lt(923688),fogDensity:.011,moonInt:.5,moonCol:new lt(13417386),moonElev:20,ambSky:new lt(3354197),ambGnd:new lt(1843224),ambInt:.55,stars:.35,bio:.65,plRange:17,plInt:.5}],pi=new lt,Ru=new lt;function OM(s){ho=s.scene,uo=s.moon,wl=s.moon2,fo=s.hemiLight,Er=s.playerLight}function zM(s){if(!ho)return;fr=(fr+s/FM)%1;const t=fr*4,e=Math.floor(t)%4,n=(e+1)%4,i=t-Math.floor(t),o=.5-.5*Math.cos(i*Math.PI),r=Cu[e],a=Cu[n];Kf=o<.5?r.label:a.label;const c=(l,h)=>l+(h-l)*o;if(pi.copy(r.sky).lerp(a.sky,o),ho.background.copy(pi),pi.copy(r.fog).lerp(a.fog,o),ho.fog.color.copy(pi),ho.fog.density=c(r.fogDensity,a.fogDensity),uo){pi.copy(r.moonCol).lerp(a.moonCol,o),uo.color.copy(pi),uo.intensity=c(r.moonInt,a.moonInt);const l=fr*Math.PI*2,h=c(r.moonElev,a.moonElev)*Math.PI/180,u=60;uo.position.set(Math.cos(l)*Math.cos(h)*u,Math.sin(h)*u,Math.sin(l)*Math.cos(h)*u)}if(wl){const l=c(r.moonInt,a.moonInt)/.85;wl.intensity=.3*l}fo&&(pi.copy(r.ambSky).lerp(a.ambSky,o),Ru.copy(r.ambGnd).lerp(a.ambGnd,o),fo.color.copy(pi),fo.groundColor.copy(Ru),fo.intensity=c(r.ambInt,a.ambInt)),Er&&(Er.distance=c(r.plRange,a.plRange),Er.intensity=c(r.plInt,a.plInt)),Au=c(r.stars,a.stars),zv(Au),Ae=c(r.bio,a.bio)}let $r=0,Ql=0,Tr=0,Ar="CLEAR",Os=!1,ni=0;const Cr={CLEAR:{fogMult:1,windBase:.3,rainRate:0,skyDarken:0,mistCount:0,duration:[90,180]},MISTY:{fogMult:1.8,windBase:.2,rainRate:0,skyDarken:.05,mistCount:6,duration:[60,150]},LIGHT_RAIN:{fogMult:1.3,windBase:.6,rainRate:.3,skyDarken:.1,mistCount:2,duration:[60,120]},HEAVY_RAIN:{fogMult:1.6,windBase:1,rainRate:.8,skyDarken:.2,mistCount:3,duration:[45,100]},FOG_BANK:{fogMult:2.5,windBase:.15,rainRate:0,skyDarken:.1,mistCount:8,duration:[60,120]},LUMINOUS_STORM:{fogMult:1.4,windBase:1.5,rainRate:.6,skyDarken:.15,mistCount:2,duration:[40,90]}},BM={CLEAR:{MISTY:.4,LIGHT_RAIN:.3,FOG_BANK:.2,LUMINOUS_STORM:.1},MISTY:{CLEAR:.3,LIGHT_RAIN:.3,FOG_BANK:.3,HEAVY_RAIN:.1},LIGHT_RAIN:{CLEAR:.2,MISTY:.2,HEAVY_RAIN:.4,LUMINOUS_STORM:.2},HEAVY_RAIN:{LIGHT_RAIN:.4,LUMINOUS_STORM:.3,MISTY:.2,CLEAR:.1},FOG_BANK:{MISTY:.4,CLEAR:.3,LIGHT_RAIN:.2,LUMINOUS_STORM:.1},LUMINOUS_STORM:{HEAVY_RAIN:.3,MISTY:.3,CLEAR:.2,LIGHT_RAIN:.2}};let _s="CLEAR",ms=null,Rr=0,dr=0,ja=0,pr=!1,mr=0,Qa=Math.random()*Math.PI*2,tc=0,ec=0;const Sl=[],kM=8;let Pu=!1,nc=0,gr=1,ic=0,_r=0,sc=0;function GM(){const s=BM[_s],t=Object.entries(s);let e=0;for(const[,i]of t)e+=i;let n=Math.random()*e;for(const[i,o]of t)if(n-=o,n<=0)return i;return t[0][0]}function HM(){if(Pu)return;const s=document.createElement("canvas");s.width=128,s.height=64;const t=s.getContext("2d"),e=t.createRadialGradient(64,32,0,64,32,64);e.addColorStop(0,"rgba(255,255,255,0.5)"),e.addColorStop(.3,"rgba(255,255,255,0.25)"),e.addColorStop(.7,"rgba(255,255,255,0.06)"),e.addColorStop(1,"rgba(255,255,255,0)"),t.fillStyle=e,t.fillRect(0,0,128,64);const n=new Bl(s),i=new Me(40,14);for(let o=0;o<kM;o++){const r=new K({map:n,color:5596791,transparent:!0,opacity:0,side:kt,depthWrite:!1}),a=new I(i,r);a.visible=!1,vt.add(a),Sl.push({mesh:a,mat:r,active:!1,drift:Math.random()*Math.PI*2,speed:.3+Math.random()*.4,baseY:.8+Math.random()*2,wobble:Math.random()*Math.PI*2})}Pu=!0}function VM(){HM();const s=Cr.CLEAR.duration;Rr=s[0]+Math.random()*(s[1]-s[0])}function WM(s,t,e){if(pr)if(dr-=s,dr<=0){_s=ms,ms=null,pr=!1;const o=Cr[_s].duration;Rr=o[0]+Math.random()*(o[1]-o[0]),mr=0}else mr=1-dr/ja;else Rr-=s,Rr<=0&&(ms=GM(),pr=!0,ja=30+Math.random()*60,dr=ja,mr=0);const n=Cr[_s];if(pr&&ms){const o=Cr[ms],r=.5-.5*Math.cos(mr*Math.PI),a=(c,l)=>c+(l-c)*r;gr=a(n.fogMult,o.fogMult),ic=a(n.rainRate,o.rainRate),_r=a(n.skyDarken,o.skyDarken),sc=a(n.mistCount,o.mistCount),Tr=a(n.windBase,o.windBase),Ar=r<.5?_s:ms}else gr=n.fogMult,ic=n.rainRate,_r=n.skyDarken,sc=n.mistCount,Tr=n.windBase,Ar=_s;Os=Ar==="LUMINOUS_STORM",Qa+=(Math.sin(t*.05)*.2+Math.sin(t*.13)*.1)*s,tc-=s,tc<=0&&(tc=2+Math.random()*6,ec=Math.random()*.8),ec*=Math.pow(.3,s);const i=Tr+ec;if($r=Math.cos(Qa)*i,Ql=Math.sin(Qa)*i,vt.fog.density*=gr,_r>.001){const o=vt.background,r=1-_r;o.r*=r,o.g*=r,o.b*=r}if(e){const o=Math.round(sc);for(let r=0;r<Sl.length;r++){const a=Sl[r];if(r<o){a.active||(a.active=!0,a.mesh.visible=!0,a.drift=Math.random()*Math.PI*2);const c=10+Math.sin(t*.3+a.wobble)*8,l=a.drift+t*a.speed*.05;a.mesh.position.set(e.x+Math.cos(l)*c,a.baseY+Math.sin(t*.4+a.wobble)*.5,e.z+Math.sin(l)*c),a.mesh.rotation.y=l+Math.PI/2,a.drift+=$r*s*.02;const h=.03+gr*.012;a.mat.opacity+=(h-a.mat.opacity)*s*2}else a.active&&(a.mat.opacity-=s*.5,a.mat.opacity<=.005&&(a.active=!1,a.mesh.visible=!1,a.mat.opacity=0))}}return Os&&(nc-=s,nc<=0&&(nc=1+Math.random()*4,ni=1)),ni*=Math.pow(.02,s),ni<.01&&(ni=0),ic}const Fn=300,eo=new Float32Array(Fn),no=new Float32Array(Fn),io=new Float32Array(Fn),oc=new Float32Array(Fn),rc=new Float32Array(Fn),ac=new Float32Array(Fn),zi=new Float32Array(Fn),mn=new Float32Array(Fn*6);let Vi=null,bl=null;function XM(){const s=new Ie;s.setAttribute("position",new En(mn,3)),bl=new af({color:8952251,transparent:!0,opacity:.3,depthWrite:!1}),Vi=new Ap(s,bl),Vi.frustumCulled=!1,Vi.visible=!1,vt.add(Vi);for(let t=0;t<Fn;t++)zi[t]=0,Jf(t)}function Jf(s){const t=s*6;mn[t]=0,mn[t+1]=-100,mn[t+2]=0,mn[t+3]=0,mn[t+4]=-100,mn[t+5]=0}function YM(s,t,e,n,i){if(!Vi)return;const o=e>.01;if(Vi.visible=o,!o)return;bl.opacity=Math.min(.15+e*.35,.5);const r=Math.floor(e*12*s*60);for(let c=0;c<r;c++){let l=-1;for(let f=0;f<Fn;f++)if(zi[f]<=0){l=f;break}if(l===-1)break;const h=Math.random()*Math.PI*2,u=Math.random()*30;eo[l]=t.x+Math.cos(h)*u,no[l]=12+Math.random()*10,io[l]=t.z+Math.sin(h)*u,oc[l]=n*2+(Math.random()-.5)*.3,rc[l]=-12-Math.random()*8,ac[l]=i*2+(Math.random()-.5)*.3,zi[l]=2+Math.random()*1.5}const a=.06;for(let c=0;c<Fn;c++){if(zi[c]<=0)continue;if(zi[c]-=s,zi[c]<=0||no[c]<ie(eo[c],io[c])+.1){zi[c]=0,Jf(c);continue}eo[c]+=oc[c]*s,no[c]+=rc[c]*s,io[c]+=ac[c]*s;const l=c*6;mn[l]=eo[c],mn[l+1]=no[c],mn[l+2]=io[c],mn[l+3]=eo[c]+oc[c]*a,mn[l+4]=no[c]+rc[c]*a,mn[l+5]=io[c]+ac[c]*a}Vi.geometry.attributes.position.needsUpdate=!0}let El=null,cc=60;const qM={DUSK:"Dusk",NIGHT:"Night",DEEP_NIGHT:"Deep Night",DAWN:"Dawn"},ZM={CLEAR:"Clear",MISTY:"Misty",LIGHT_RAIN:"Light Rain",HEAVY_RAIN:"Heavy Rain",FOG_BANK:"Fog",LUMINOUS_STORM:"Storm"};function $M(){El=document.getElementById("hud")}function KM(s,t){if(!El)return;cc=cc*.95+1/Math.max(s,.001)*.05;const e=bn==="SEEK"?"Seek the orbs...":bn==="RISING"?"The obelisk stirs...":bn==="COMPLETE"?"Convergence!":"Luminaries",n=qM[Kf]||"Night",i=ZM[Ar]||"Clear";El.innerHTML="<b>"+e+"</b> · "+n+" · "+i+" · FPS:"+Math.round(cc)+"<br>Pos:"+t.x.toFixed(0)+","+t.z.toFixed(0)}let Kr=null;function JM(){Kr=document.getElementById("orb-hud")}function jM(){return Kr}function QM(){const s=document.getElementById("overlay");s&&(s.style.opacity="0",setTimeout(()=>{try{s.remove()}catch{}},2500)),Kr&&(Kr.style.display="block")}const me=[],ln=[],re=[],To=[],ei=[],Ao=[],Co=[],Tl=[],Ro=[],Ki=[],Al=[],Jr=[],jr=[],th=[],Qr=[],Gn=[],gn=[],_n=[],mi=[];let Iu=0,Lu=0,lc=0,Ii=null,so=0;function ty(){for(let s=0;s<Zx;s++){let t,e,n=!1;for(let i=0;i<20;i++){const o=S()*6.28,r=5+S()*(le-10);t=Math.cos(o)*r,e=Math.sin(o)*r,n=!0;for(let a=0;a<me.length;a++){const c=me[a].x-t,l=me[a].z-e;if(c*c+l*l<9){n=!1;break}}if(n)break}if(n){const i=Hv(t,e);i.position.y=ie(t,e),me.push({group:i,x:t,z:e})}}for(let s=0;s<$x;s++){const t=me[Math.floor(S()*me.length)],e=S()*6.28,n=1+S()*4,i=t.x+Math.cos(e)*n,o=t.z+Math.sin(e)*n,r=Vv(i,o);r.group.position.y=ie(i,o),ln.push(r)}for(let s=0;s<Kx;s++){const t=S()*6.28,e=8+S()*le*.6,n=Math.cos(t)*e,i=Math.sin(t)*e,o=Wv(n,i);o.group.position.y=ie(n,i),re.push(o)}for(let s=0;s<Jx;s++){const t=S()*6.28,e=10+S()*le*.5,n=Math.cos(t)*e,i=Math.sin(t)*e;To.push(eM(n,ie(n,i)+3+S()*5,i))}for(let s=0;s<jx;s++){const t=ln[Math.floor(S()*ln.length)],e=S()*6.28,n=1+S()*5,i=t.x+Math.cos(e)*n,o=t.z+Math.sin(e)*n,r=nM(i,o);r.group.position.y=ie(i,o),r._baseY=ie(i,o),ei.push(r)}for(let s=0;s<Qx;s++){const t=S()*6.28,e=12+S()*le*.5,n=Math.cos(t)*e,i=Math.sin(t)*e,o=iM(n,i),r=ie(n,i);o.group.position.y=r,o._baseY=r,Ao.push(o)}for(let s=0;s<tv;s++){const t=me[Math.floor(S()*me.length)];Co.push(sM(t.x,ie(t.x,t.z)+2+S()*4,t.z))}for(let s=0;s<ev;s++){const t=S()*6.28,e=2+S()*(le*.9),n=Math.cos(t)*e,i=Math.sin(t)*e,o=Xv(n,i,2+S()*2.5,25+Math.floor(S()*20));o.mesh.position.y=ie(n,i),Tl.push(o)}for(let s=0;s<ov;s++){let t,e,n=!1;for(let i=0;i<10;i++){const o=S()*6.28,r=3+S()*(le*.85);t=Math.cos(o)*r,e=Math.sin(o)*r,n=!0;for(let a=0;a<me.length;a++){const c=me[a].x-t,l=me[a].z-e;if(c*c+l*l<4){n=!1;break}}if(n)break}if(n){const i=hM(t,e);i.group.position.y=ie(t,e),Jr.push(i)}}for(let s=0;s<nv;s++){const t=me[Math.floor(S()*me.length)],e=S()*6.28,n=1+S()*5,i=t.x+Math.cos(e)*n,o=t.z+Math.sin(e)*n,r=qv(i,o);r.group.position.y=ie(i,o),Ro.push(r)}for(let s=0;s<iv;s++){const t=S()*6.28,e=3+S()*(le*.7),n=Math.cos(t)*e,i=Math.sin(t)*e,o=Zv(n,i);o.group.position.y=ie(n,i),Ki.push(o)}for(let s=0;s<sv;s++){const t=S()*6.28,e=4+S()*(le*.8),n=Math.cos(t)*e,i=Math.sin(t)*e,o=$v(n,i);o.group.position.y=ie(n,i),Al.push(o)}for(let s=0;s<ol;s++){let t,e,n=!1;for(let i=0;i<30;i++){const o=S()*6.28,r=20+S()*(le*.6);t=Math.cos(o)*r,e=Math.sin(o)*r,n=!0;for(let a=0;a<_n.length;a++){const c=_n[a].x-t,l=_n[a].z-e;if(c*c+l*l<225){n=!1;break}}if(n)break}if(n){const i=lM(t,e);i.group.position.y=ie(t,e)+1,i.flyY=ie(t,e)+1,_n.push(i)}}for(let s=0;s<Ef;s++){const t=S()*6.28,e=2+S()*3,n=Math.cos(t)*e,i=Math.sin(t)*e;jr.push(oM(n,ie(n,i)+1+S()*.5,i))}for(let s=0;s<rv;s++){const t=S()*6.28,e=4+S()*(le*.7),n=Math.cos(t)*e,i=Math.sin(t)*e,o=Qv(n,i);o.group.position.y=ie(n,i),th.push(o)}for(let s=0;s<av;s++){let t,e,n=!1;for(let i=0;i<20;i++){const o=S()*6.28,r=10+S()*(le*.6);t=Math.cos(o)*r,e=Math.sin(o)*r,n=!0;for(let a=0;a<me.length;a++){const c=me[a].x-t,l=me[a].z-e;if(c*c+l*l<36){n=!1;break}}if(n)break}if(n){hl(t,e,4);const i=rM(t,e);i.group.position.y=ie(t,e),Qr.push(i)}}for(let s=0;s<cv;s++){const t=S()*6.28,e=5+S()*le*.6,n=Math.cos(t)*e,i=Math.sin(t)*e;Gn.push(aM(n,ie(n,i)+.5+S()*5,i))}for(let s=0;s<hv;s++){let t,e,n=!1;for(let i=0;i<20;i++){const o=S()*6.28,r=8+S()*(le*.6);t=Math.cos(o)*r,e=Math.sin(o)*r,n=!0;for(let a=0;a<me.length;a++){const c=me[a].x-t,l=me[a].z-e;if(c*c+l*l<16){n=!1;break}}if(n)break}if(n){hl(t,e,3);const i=cM(t,e);i.group.position.y=ie(t,e),gn.push(i)}}}function jf(s,t){const e=1+Tr*1.5,n=$r*.03,i=Ql*.03;for(let o=0;o<Tl.length;o++)Yv(Tl[o],t,e,n,i,st.pos.x,st.pos.z);for(let o=0;o<Ro.length;o++){const r=Ro[o];r.group.rotation.z=Math.sin(t*.8+r.phase)*.03*e+n,r.group.rotation.x=Math.sin(t*.6+r.phase+1)*.02*e+i}for(let o=0;o<Ki.length;o++){const r=Ki[o],a=Math.sin(t*1+r.phase)*.5+.5;r.petalMat.emissiveIntensity=(.3+a*.5)*Ae,r.group.rotation.z=Math.sin(t*.9+r.phase)*.04*e+n*.5}for(let o=0;o<Al.length;o++){const r=Al[o];r.group.rotation.z=Math.sin(t*1.1+r.phase)*r.swayAmp*e+n,r.group.rotation.x=Math.sin(t*.8+r.phase+2)*r.swayAmp*.5*e+i}}function Qf(s,t){for(let e=0;e<To.length;e++){const n=To[e],i=n.group,o=i.position.x,r=i.position.z;if(n._stT-=s,n._stT<=0)if(Os)n._state="display",n._stT=10+Math.random()*15;else{const h=Math.random();h<.5?(n._state="drift",n._stT=20+Math.random()*30):h<.75?(n._state="pulse",n._stT=8+Math.random()*12):(n._state="migrate",n._migrateAng=Math.random()*6.28,n._stT=15+Math.random()*20)}switch(Os&&n._state!=="display"&&(n._state="display",n._stT=10),n._state){case"drift":{n.driftAng+=s*.15;const h=8+Math.sin(t*.1+n.phase)*4,u=n.homeX+Math.cos(n.driftAng)*h,f=n.homeZ+Math.sin(n.driftAng)*h;i.position.x+=(u-o)*s*.3,i.position.z+=(f-r)*s*.3,i.position.y=n.floatY+Math.sin(t*n.wobble+n.phase)*1.5;break}case"pulse":{n.driftAng+=s*.08,i.position.x+=Math.cos(n.driftAng)*s*.3,i.position.z+=Math.sin(n.driftAng)*s*.3,i.position.y=n.floatY+Math.sin(t*n.wobble+n.phase)*1,n._pulseSync=Math.sin(t*2+Math.floor(e/2)*Math.PI)*.5+.5;break}case"migrate":{i.position.x+=Math.cos(n._migrateAng)*s*1,i.position.z+=Math.sin(n._migrateAng)*s*1,i.position.y=n.floatY+Math.sin(t*n.wobble+n.phase)*.8,i.position.x*i.position.x+i.position.z*i.position.z>le*.8*(le*.8)&&(n._migrateAng+=Math.PI);break}case"display":{n.driftAng+=s*.4,i.position.x+=Math.cos(n.driftAng)*s*.8,i.position.z+=Math.sin(n.driftAng)*s*.8,i.position.y=n.floatY+Math.sin(t*2+n.phase)*2;break}}const a=Math.sin(t*1.2+n.phase)*.5+.5;let c=1,l=0;n._state==="pulse"?(c=1+n._pulseSync*1.5,l=n._pulseSync*.15):n._state==="display"&&(c=1.5+Math.sin(t*4+n.phase)*.8,l=.15),n.bellMat.emissiveIntensity=(.4+a*.8)*Ae*c,n.bellMat.opacity=.35+a*.25+l,i.rotation.y+=s*.2;for(let h=2;h<i.children.length;h++)i.children[h].rotation.x=Math.sin(t*2+h+n.phase)*.15,i.children[h].rotation.z=Math.sin(t*1.5+h*.7+n.phase)*.1}}function td(s,t){const e=Ce.ShiftLeft||Ce.ShiftRight||Do;for(let n=0;n<ei.length;n++){const i=ei[n],o=i.group,r=o.position.x,a=o.position.z,c=r-st.pos.x,l=a-st.pos.z,h=c*c+l*l;if(i.state!=="startled"&&i.state!=="following"&&i.state!=="huddle"){const g=e?3.5:2;h<g*g&&(i.state="startled",i._scaredT=.6+Math.random()*.5,i.wanderAng=Math.atan2(c,l),i.hopTimer=0)}if(Os&&i.state!=="startled"&&i.state!=="huddle"){let g=1/0,_=-1;for(let p=0;p<ei.length;p++){if(p===n)continue;const d=ei[p].group.position.x-r,y=ei[p].group.position.z-a,v=d*d+y*y;v<g&&(g=v,_=p)}_>=0&&g>1&&(i.state="huddle",i._huddleTarget=_)}Fs>8&&h<144&&i.state==="idle"&&Math.random()<.001&&(i.state="following",i._followT=10+Math.random()*10);const u=r-i._lastTX,f=a-i._lastTZ;switch(u*u+f*f>.25&&(i._baseY=ie(r,a),i._lastTX=r,i._lastTZ=a),i.state){case"idle":{i.idleTimer-=s,o.position.y=i._baseY+Math.sin(t*2+i.phase)*.02,o.rotation.y+=Math.sin(t*.5+i.phase)*s*.3,i.idleTimer<=0&&(i.state="hop",i.wanderAng+=(Math.random()-.5)*1.5,i.hopTimer=0);break}case"hop":{i.hopTimer+=s;const _=i.hopTimer/1.2;if(_>=1)i.state="idle",i.idleTimer=1.5+Math.random()*3,o.position.y=i._baseY;else{o.position.y=i._baseY+Math.sin(_*Math.PI)*.3,o.position.x+=Math.sin(i.wanderAng)*i.speed*s,o.position.z+=Math.cos(i.wanderAng)*i.speed*s;const p=1-Math.sin(_*Math.PI)*.15,d=1+Math.sin(_*Math.PI)*.2;o.scale.set(p,d,p),o.rotation.y=i.wanderAng}break}case"startled":{i._scaredT-=s,i.hopTimer+=s*1.5;const g=Math.min(i.hopTimer/.8,1);o.position.y=i._baseY+Math.sin(g*Math.PI)*.5,o.position.x+=Math.sin(i.wanderAng)*i.speed*2*s,o.position.z+=Math.cos(i.wanderAng)*i.speed*2*s,o.scale.set(.85,1.3,.85),i._scaredT<=0&&(i.state="idle",i.idleTimer=3+Math.random()*3,o.position.y=i._baseY,o.scale.set(1,1,1));break}case"following":{if(i._followT-=s,h>225||Fs<3||i._followT<=0){i.state="idle",i.idleTimer=2;break}if(i.wanderAng=Math.atan2(st.pos.x-r,st.pos.z-a),h>9){i.hopTimer+=s;const g=i.hopTimer%1.5/1.5;o.position.y=i._baseY+Math.sin(g*Math.PI)*.2,o.position.x+=Math.sin(i.wanderAng)*i.speed*.4*s,o.position.z+=Math.cos(i.wanderAng)*i.speed*.4*s}else o.position.y=i._baseY+Math.sin(t*3+i.phase)*.03;o.rotation.y=i.wanderAng;break}case"huddle":{if(!Os){i.state="idle",i.idleTimer=2;break}const g=ei[i._huddleTarget];if(g){const _=g.group.position.x-r,p=g.group.position.z-a,d=Math.sqrt(_*_+p*p);d>.5&&(o.position.x+=_/d*i.speed*.5*s,o.position.z+=p/d*i.speed*.5*s)}o.rotation.z=Math.sin(t*8)*.05,o.position.y=i._baseY;break}}if(i._blinkTimer-=s,i._blinkTimer<=0)if(i._blinkState===0){for(let g=0;g<i.eyes.length;g++)i.eyes[g].scale.y=.1;i._blinkState=1,i._blinkTimer=.08+Math.random()*.06}else{for(let g=0;g<i.eyes.length;g++)i.eyes[g].scale.y=1;i._blinkState=0,i._blinkTimer=2+Math.random()*5}for(let g=0;g<i.ears.length;g++){const _=i.ears[g];_.mesh.rotation.z=_.baseRotZ+Math.sin(t*3.5+_.side*1.2+i.phase)*.08}i.tail.position.y=.38+Math.sin(t*4+i.phase)*.015,o.position.x*o.position.x+o.position.z*o.position.z>le*.85*(le*.85)&&(i.wanderAng+=Math.PI)}}function ed(s,t){const e=Ce.ShiftLeft||Ce.ShiftRight||Do;for(let n=0;n<Ao.length;n++){const i=Ao[n],o=i.group,r=o.position.x,a=o.position.z,c=r-st.pos.x,l=a-st.pos.z,h=c*c+l*l,u=Math.atan2(c,l),f=e?18:12,m=f*f,g=e?10:mv,_=g*g,p=r-i._lastTX,d=a-i._lastTZ;p*p+d*d>.25&&(i._baseY=ie(r,a),i._lastTX=r,i._lastTZ=a);const y=i._baseY;i.state!=="flee"&&i.state!=="alert"&&i.state!=="watching"&&(h<_?(i.state="flee",i.wanderAng=u,i.fleeTimer=2.5+Math.random()*2,i._zigTimer=0):h<m&&(i.state="alert",i._stT=1+Math.random()*1.5));let v=i.speed,x=!1;switch(i.state){case"walk":{if(x=!0,i.walkTimer-=s,i.walkTimer<=0){const A=Math.random();if(A<.25)i.state="pause",i.pauseTimer=2+Math.random()*3;else if(A<.4)i.state="graze",i._stT=3+Math.random()*4;else if(A<.5&&gn.length>0){i.state="drink",i._stT=8;let w=1/0;for(let M=0;M<gn.length;M++){const P=gn[M].x-r,F=gn[M].z-a,U=P*P+F*F;U<w&&(w=U,i._drinkTgt=gn[M])}}else A<.55?(i.state="rest",i._stT=5+Math.random()*5):(i.wanderAng+=(Math.random()-.5)*1.2,i.walkTimer=3+Math.random()*5)}if((r-i.homeX)*(r-i.homeX)+(a-i.homeZ)*(a-i.homeZ)>400){const A=Math.atan2(i.homeX-r,i.homeZ-a);i.wanderAng+=(A-i.wanderAng)*s*.5}break}case"pause":{i.pauseTimer-=s,i.headLook=Math.sin(t*.6)*.4,i.pauseTimer<=0&&(i.state="walk",i.walkTimer=3+Math.random()*5);break}case"graze":{i._stT-=s,i.headBob=-.5,i._stT<=0&&(i.state="walk",i.walkTimer=2+Math.random()*4,i.headBob=0);break}case"drink":{if(i._stT-=s,i._drinkTgt){const b=i._drinkTgt.x-r,A=i._drinkTgt.z-a;Math.sqrt(b*b+A*A)>2?(i.wanderAng=Math.atan2(b,A),x=!0,v=i.speed*.7):i.headBob=-.6}i._stT<=0&&(i.state="walk",i.walkTimer=3+Math.random()*4,i.headBob=0,i._drinkTgt=null);break}case"rest":{i._stT-=s,o.position.y=Math.max(y-.3,o.position.y-s*.5),i._stT<=0&&(i.state="walk",i.walkTimer=2+Math.random()*3);break}case"alert":{i._stT-=s,h<_?(i.state="flee",i.wanderAng=u,i.fleeTimer=2.5+Math.random()*2):i._stT<=0&&(h<f*1.2*(f*1.2)?(i.state="watching",i._stT=3+Math.random()*3):(i.state="walk",i.walkTimer=2+Math.random()*3));break}case"watching":{i._stT-=s,x=!0,v=i.speed*.3,i.wanderAng=u,h<_?(i.state="flee",i.wanderAng=u,i.fleeTimer=2.5+Math.random()*2):(h>f*1.5*(f*1.5)||i._stT<=0)&&(i.state="walk",i.walkTimer=2+Math.random()*4);break}case"flee":{x=!0,v=i.speed*gv,i.fleeTimer-=s,i._zigTimer-=s,i._zigTimer<=0&&(i._zigDir*=-1,i._zigTimer=.4+Math.random()*.4),i.wanderAng=u+i._zigDir*.3,(i.fleeTimer<=0||h>f*2*(f*2))&&(i.state="walk",i.walkTimer=3+Math.random()*5);break}}if(x&&(o.position.x+=Math.sin(i.wanderAng)*v*s,o.position.z+=Math.cos(i.wanderAng)*v*s,i.legCycle+=s*v*3),o.position.x*o.position.x+o.position.z*o.position.z>le*.9*(le*.9)&&(i.wanderAng=Math.atan2(-o.position.x,-o.position.z)),i.state!=="rest"){const b=y-o.position.y;Math.abs(b)>.01?o.position.y+=Math.sign(b)*Math.min(Math.abs(b),s*2):o.position.y=y}if(o.rotation.y=i.wanderAng,i.state==="alert"||i.state==="watching"){const b=u-i.wanderAng;i.headLook+=(b*.5-i.headLook)*s*3}const T=i.headBob||0;i.neckPivot.rotation.x+=(T-i.neckPivot.rotation.x)*s*3,i.neckPivot.rotation.y+=(i.headLook-i.neckPivot.rotation.y)*s*4,x&&i.state!=="graze"&&i.state!=="drink"&&(i.neckPivot.rotation.x+=Math.sin(i.legCycle*2)*.05);for(let b=0;b<i.legPivots.length;b++){const A=i.legPivots[b];if(x){const w=A.isFront?0:Math.PI,M=A.side>0?Math.PI:0,P=Math.sin(i.legCycle+w+M)*.4*(v/i.speed);A.upper.rotation.x=P,A.lower.rotation.x=Math.max(0,-P*.6)}else i.state==="rest"&&o.position.y<-.1?(A.upper.rotation.x+=(.8-A.upper.rotation.x)*s*2,A.lower.rotation.x+=(1-A.lower.rotation.x)*s*2):(A.upper.rotation.x*=.9,A.lower.rotation.x*=.9)}i.tailPivot.rotation.x=Math.sin(t*1.5+i.phase)*.15,i.state==="flee"&&(i.tailPivot.rotation.x+=.3),i.state==="alert"?i.tailPivot.rotation.z=Math.sin(t*6)*.1:i.tailPivot.rotation.z*=.9,i.mat.emissiveIntensity=(.3+Math.sin(t*.8+i.phase)*.2)*Ae,i.headLook*=.98}}function nd(s,t){for(let e=0;e<Co.length;e++){const n=Co[e],i=n.group,o=i.position.x,r=i.position.z;if(n._state==="patrol"){if(Math.random()<.002){let u=1/0,f=null;for(let m=0;m<re.length;m++){const g=re[m].x-o,_=re[m].z-r,p=g*g+_*_;p<900&&p<u&&(u=p,f=re[m])}f&&(n._state="attracted",n._attractTarget=f,n._stT=6+Math.random()*8)}if(Math.random()<.001){let u=1/0,f=null;for(let m=0;m<me.length;m++){const g=me[m].x-o,_=me[m].z-r,p=g*g+_*_;p<400&&p<u&&(u=p,f=me[m])}f&&(n._state="rest",n._restTree=f,n._stT=4+Math.random()*6)}}switch(n._state){case"patrol":{n.orbitAng+=s*.4;const u=n.centerX+Math.cos(n.orbitAng)*n.orbitR,f=n.centerZ+Math.sin(n.orbitAng)*n.orbitR;i.position.x+=(u-o)*s*1.5,i.position.z+=(f-r)*s*1.5,i.position.y=n.floatY+Math.sin(t*.7+n.phase)*.8,i.rotation.y=n.orbitAng+Math.PI/2;break}case"attracted":{if(n._stT-=s,!n._attractTarget||n._stT<=0){n._state="patrol",n._attractTarget=null;break}n.orbitAng+=s*.8;const u=n._attractTarget,f=Math.max(.5,n._stT*.4),m=u.x+Math.cos(n.orbitAng)*f,g=u.z+Math.sin(n.orbitAng)*f;i.position.x+=(m-o)*s*2,i.position.z+=(g-r)*s*2,i.position.y+=(2-i.position.y)*s*.5,i.rotation.y=n.orbitAng+Math.PI/2;break}case"rest":{if(n._stT-=s,!n._restTree||n._stT<=0){n._state="patrol",n._restTree=null,n.centerX=i.position.x,n.centerZ=i.position.z;break}const u=n._restTree,f=u.x+.5-o,m=u.z+.5-r,g=Math.sqrt(f*f+m*m);g>.3&&(i.position.x+=f/g*s*2,i.position.z+=m/g*s*2),i.position.y+=(2.5-i.position.y)*s*1.5,i.rotation.y=Math.atan2(f,m);break}}const a=n._state==="rest"?.05:.4,c=Math.sin(t*n.flapSpeed+n.phase)*a;for(let u=0;u<i._wingPivots.length;u++){const f=i._wingPivots[u];f.pivot.rotation.z=c*f.side}const l=Math.sin(t*1.5+n.phase)*.5+.5,h=n._state==="attracted"?.4:0;n.wingMat.emissiveIntensity=(.5+l*.6+h)*Ae,n.wingMat.opacity=.45+l*.25}}function ey(s,t){const e=Ce.ShiftLeft||Ce.ShiftRight||Do;let n=null;if(Fs>5&&(bn==="SEEK"||bn==="RISING")){let i=1/0;for(let o=0;o<_n.length;o++){if(_n[o].found)continue;const r=_n[o].x-st.pos.x,a=_n[o].z-st.pos.z,c=r*r+a*a;c<i&&(i=c,n=_n[o])}}for(let i=0;i<jr.length;i++){const o=jr[i],r=t*.5+o.phase+i/Ef*6.28,a=e?4+i*2:1.5+i*.8,c=e?3+i:1.2+Math.sin(t*.7+o.phase)*.5;if(o.targetX=st.pos.x+Math.cos(r)*a,o.targetY=st.pos.y-sa+c,o.targetZ=st.pos.z+Math.sin(r)*a,i===0&&n){const g=Math.min((Fs-5)/3,.6);o.targetX+=(n.x-st.pos.x)*g,o.targetZ+=(n.z-st.pos.z)*g,o.targetY+=.5}const l=e?.8:2.5;o.velX+=(o.targetX-o.group.position.x)*l*s,o.velY+=(o.targetY-o.group.position.y)*l*s,o.velZ+=(o.targetZ-o.group.position.z)*l*s,o.velX*=.92,o.velY*=.92,o.velZ*=.92,o.group.position.x+=o.velX*s*4,o.group.position.y+=o.velY*s*4,o.group.position.z+=o.velZ*s*4;const h=Math.sin(t*2+o.phase)*.5+.5;o.glowMat.opacity=.3+h*.4,o.hazeMat.opacity=.08+h*.12;const u=t*(2.5+i*.5)+o.phase,f=.14+Math.sin(t*1.3+o.phase)*.06;o.group.children[5].position.set(Math.cos(u)*f,Math.sin(u*1.5)*.08,Math.sin(u)*f);for(let g=0;g<o.tendrils.length;g++){const _=o.tendrils[g],p=Math.sin(t*3+g*2.1+o.phase)*.3,d=.08+Math.sin(t*2+g*1.5)*.04;_.mesh.position.x=Math.cos(_.baseAng+p)*d,_.mesh.position.z=Math.sin(_.baseAng+p)*d,_.mesh.rotation.y=_.baseAng+p,_.mesh.rotation.z=Math.PI/3+Math.sin(t*2.5+g)*.2}for(let g=0;g<o.embers.length;g++){const _=(g+1)*.08;o.embers[g].position.y=-.06-_+Math.sin(t*4+g*1.4+o.phase)*.03,o.embers[g].position.x=Math.sin(t*2.5+g*2+o.phase)*.06,o.embers[g].material.opacity=.2+Math.sin(t*5+g*1.7)*.15}o.facet.rotation.y+=s*1.5,o.facet.rotation.x+=s*.7,o.halo.rotation.z+=s*.3,o.halo2.rotation.y+=s*.2}}function ny(s,t){for(let e=0;e<Qr.length;e++){const n=Qr[e],i=n.x-st.pos.x,o=n.z-st.pos.z,a=i*i+o*o<(sl+.5)*(sl+.5),c=a?1:0;n.glowIntensity+=(c-n.glowIntensity)*s*3,n.discMat.opacity=n.glowIntensity*.25*(.6+Math.sin(t*2+n.phase)*.4),n.mushMat.emissiveIntensity=(.2+n.glowIntensity*.8)*Ae,a&&st.vel.y>0&&st.vel.y<=Br+.5&&(st.vel.y=Br+fv,n.glowIntensity=1.5);const l=.08+n.glowIntensity*.25;n.sporeMat.opacity=l;for(let h=0;h<n.spores.length;h++){const u=n.spores[h];u.drift+=s*.3,u.mesh.position.y+=u.speed*s*(.5+n.glowIntensity),u.mesh.position.x=u.baseX+Math.sin(t*.8+u.drift)*.15,u.mesh.position.z=u.baseZ+Math.cos(t*.6+u.drift)*.12,u.mesh.position.y>.8&&(u.mesh.position.y=.03),u.mesh.scale.setScalar(.6+Math.sin(t*2+h)*.4)}for(let h=0;h<n.glowWorms.length;h++){const u=Math.sin(t*1.5+h*1.3+n.phase)*.5+.5;n.glowWorms[h].material.opacity=.1+u*.4+n.glowIntensity*.3}}}function iy(s,t){for(let e=0;e<Gn.length;e++){const n=Gn[e];if(n.popped){if(n.popTimer-=s,n.popTimer<=0){n.popped=!1,n.group.visible=!0;const h=S()*6.28,u=8+S()*le*.5;n.homeX=Math.cos(h)*u,n.homeZ=Math.sin(h)*u,n.floatY=.5+S()*4,n.group.position.set(n.homeX,n.floatY,n.homeZ)}continue}n.driftAng+=s*.2;const i=n.homeX+Math.sin(n.driftAng)*3,o=n.homeZ+Math.cos(n.driftAng*.7)*3;n.group.position.x+=(i-n.group.position.x)*s*.5,n.group.position.z+=(o-n.group.position.z)*s*.5,n.group.position.y=n.floatY+Math.sin(t*.6+n.phase)*n.bobAmp;const r=(t*.1+n.phase)%1;n.shellMat.color.setRGB(Math.sin(r*6.28)*.15+.7,Math.sin(r*6.28+2.09)*.15+.7,Math.sin(r*6.28+4.19)*.15+.8),n.shellMat.opacity=.18+Math.sin(t*1.5+n.phase)*.08;const a=n.group.position.x-st.pos.x,c=n.group.position.y-st.pos.y,l=n.group.position.z-st.pos.z;a*a+c*c+l*l<xu*xu*n.sc*n.sc&&(n.popped=!0,n.popTimer=8+Math.random()*8,n.group.visible=!1,IM(n.group.position.x,n.group.position.y,n.group.position.z,6))}}function sy(s,t){for(let e=0;e<gn.length;e++){const n=gn[e];for(let o=0;o<n.pads.length;o++)n.pads[o].mesh.position.y=.05+Math.sin(t*.8+n.pads[o].phase)*.015;n.waterMat.emissiveIntensity=(.15+Math.sin(t*1+n.phase)*.1)*Ae;const i=Math.sin(t*1.2+n.phase)*.5+.5;n.flMat.emissiveIntensity=(.3+i*.5)*Ae;for(let o=0;o<n.ripples.length;o++){const r=n.ripples[o],a=(t*.25+r.phase)%1,c=.2+a*n.pondR*.8;r.mesh.scale.setScalar(c),r.mesh.material.opacity=(1-a)*.12}for(let o=0;o<n.tadpoles.length;o++){const r=n.tadpoles[o];r.ang+=r.speed*s;const a=Math.cos(r.ang)*r.orbR,c=Math.sin(r.ang)*r.orbR;r.body.position.x=a,r.body.position.z=c,r.body.rotation.y=r.ang+Math.PI/2;const l=.02;r.tail.position.x=a-Math.cos(r.ang)*l,r.tail.position.z=c-Math.sin(r.ang)*l,r.tail.rotation.y=r.ang,r.tail.rotation.z=Math.PI/2+Math.sin(t*8+o*3)*.4}}}function oy(s,t){if(lc-=s,lc<=0){lc=.5;for(let i=0;i<re.length;i++){const o=re[i],r=o.x-st.pos.x,a=o.z-st.pos.z;if(r*r+a*a<36){Ii={x:o.x,z:o.z},so=0;break}}}if(!Ii)return;if(so+=s*12,so>30){Ii=null,so=0;return}const e=so,n=4;for(let i=0;i<ln.length;i++){const o=ln[i],r=o.x-Ii.x,a=o.z-Ii.z,c=Math.sqrt(r*r+a*a);if(Math.abs(c-e)<n){const l=1-Math.abs(c-e)/n;o.capMat.emissiveIntensity=Math.max(o.capMat.emissiveIntensity,(o.base+l*2)*Ae)}}for(let i=0;i<Ki.length;i++){const o=Ki[i],r=o.group.position.x-Ii.x,a=o.group.position.z-Ii.z,c=Math.sqrt(r*r+a*a);if(Math.abs(c-e)<n){const l=1-Math.abs(c-e)/n;o.petalMat.emissiveIntensity=Math.max(o.petalMat.emissiveIntensity,(.3+l*1.5)*Ae)}}}function ry(s,t){const e=st.pos.x,n=st.pos.z;for(let i=0;i<Ki.length;i++){const o=Ki[i],r=o.group.position.x,a=o.group.position.z,c=r-e,l=a-n,u=c*c+l*l<16?1:0;o._react=o._react||0,o._react+=(u-o._react)*s*(u>0?4:1.5);const f=1+o._react*.15;o.group.scale.set(f,1+o._react*.05,f),o.petalMat.emissiveIntensity+=o._react*.6*Ae}for(let i=0;i<ln.length;i++){const o=ln[i],r=o.x-e,a=o.z-n,l=r*r+a*a<4?1:0;o._touch=o._touch||0,o._touch+=(l-o._touch)*s*(l>0?6:1.5),o.capMat.emissiveIntensity+=o._touch*1.5*Ae;const h=1+o._touch*.08;o.group.scale.set(h,1+o._touch*.04,h)}for(let i=0;i<Ro.length;i++){const o=Ro[i],r=o.group.position.x,a=o.group.position.z,c=r-e,l=a-n,u=c*c+l*l<2.25?.65:1;o._curl=o._curl===void 0?1:o._curl,o._curl+=(u-o._curl)*s*(u<1?4:1.5),o.group.scale.set(1+(1-o._curl)*.3,o._curl,1+(1-o._curl)*.3)}for(let i=0;i<re.length;i++){const o=re[i],r=o.x-e,a=o.z-n;if(r*r+a*a<36)for(let c=0;c<re.length;c++){if(i===c)continue;const l=re[c],h=o.x-l.x,u=o.z-l.z,f=h*h+u*u;if(f<400){const m=(1-Math.sqrt(f)/20)*.8;l.mat.emissiveIntensity+=m*Ae,l.light&&(l.light.intensity+=m*.3*Ae)}}}}let xr="EXPLORE",hc=0,uc=0;function ay(s,t){let e=!1;for(let a=0;a<re.length;a++){const c=re[a].x-st.pos.x,l=re[a].z-st.pos.z;if(c*c+l*l<64){e=!0;break}}xr=e?"NEAR_CRYSTAL":"EXPLORE",hc+=s;const n=xr==="NEAR_CRYSTAL"?.08:.25,i=xr==="NEAR_CRYSTAL"?120:100;if(hc>n&&(hc=0,Vf(0,t)<i))if(xr==="NEAR_CRYSTAL")for(let c=0;c<re.length;c++){const l=re[c].x-st.pos.x,h=re[c].z-st.pos.z;l*l+h*h<100&&gl(re[c].x,ie(re[c].x,re[c].z)+1,re[c].z,3+Math.random()*4)}else{const c=Math.random()*6.28,l=5+Math.random()*25,h=st.pos.x+Math.cos(c)*l,u=st.pos.z+Math.sin(c)*l;gl(h,ie(h,u),u,6+Math.random()*10)}if(uc+=s,uc>.2){uc=0;for(let a=0;a<ln.length;a++){const c=ln[a],l=c.x-st.pos.x,h=c.z-st.pos.z;l*l+h*h<200&&Math.random()<.15&&wM(c.x,.6*c.group.scale.x,c.z)}}for(let a=0;a<ln.length;a++){const c=ln[a],l=Math.sin(t*c.speed+c.phase)*.5+.5;c.capMat.emissiveIntensity=c.base*(.5+l*.8)*Ae}for(let a=0;a<re.length;a++){const c=re[a],l=Math.sin(t*.6+c.phase)*.5+.5;c.mat.emissiveIntensity=(1+l*1.5)*Ae,c.group.children[0].rotation.y+=s*.15,c.light&&(c.light.intensity=(.3+l*.4)*Ae)}if(!mi.length)for(let a=0;a<re.length;a++)mi.push({idx:a,dist:0});const o=st.pos.x-Iu,r=st.pos.z-Lu;if(o*o+r*r>1){Iu=st.pos.x,Lu=st.pos.z;for(let a=0;a<re.length;a++){const c=re[a],l=c.x-st.pos.x,h=c.z-st.pos.z;mi[a].idx=a,mi[a].dist=l*l+h*h}mi.sort((a,c)=>a.dist-c.dist)}for(let a=0;a<Ui.length;a++)if(a<mi.length&&mi[a].dist<2500){const c=re[mi[a].idx],l=Math.sin(t*.6+c.phase)*.5+.5;Ui[a].position.set(c.x,1.5,c.z),Ui[a].intensity=(1.5+l*2)*Ae,Ui[a].distance=16,Ui[a].color.setHex(G.crystal)}else Ui[a].intensity=0;Qf(s,t),td(s,t),ed(s,t),nd(s,t),Nf(s,t),jf(s,t);for(let a=0;a<Jr.length;a++){const c=Jr[a];if(c.sparkles)for(let l=0;l<c.sparkles.length;l++)c.sparkles[l].material.opacity=.15+Math.sin(t*4+a*2.3+l*1.7)*.35}ey(s,t),tM(th,s,t,st.pos),ny(s,t),iy(s,t),sy(s,t),Xf(s,t,st.pos),jv(s,t),CM(s),LM(s),oy(s),ry(s),UM(s,t)}let Ue=0,Cl=!1;function cy(){Cl||(Cl=!0,Cv(!0),QM())}function id(){requestAnimationFrame(id);const s=Math.min(Tf.getDelta(),.1);Ue+=s,zM(s);const t=WM(s,Ue,st.pos);if(YM(s,st.pos,t,$r,Ql),ni>0&&(ql.intensity+=ni*2.5,vt.background.r=Math.min(1,vt.background.r+ni*.3),vt.background.g=Math.min(1,vt.background.g+ni*.3),vt.background.b=Math.min(1,vt.background.b+ni*.4)),!Cl){Ke.position.set(0,sa,0),Ke.rotation.order="YXZ",Ke.rotation.y+=s*.08,Ke.rotation.x=0;for(let e=0;e<ln.length;e++){const n=ln[e],i=Math.sin(Ue*n.speed+n.phase)*.5+.5;n.capMat.emissiveIntensity=n.base*(.5+i*.8)*Ae}for(let e=0;e<re.length;e++){const n=re[e];n.mat.emissiveIntensity=(1+Math.sin(Ue*.6+n.phase)*.5*1.5+.75)*Ae}Qf(s,Ue),td(s,Ue),ed(s,Ue),nd(s,Ue),Nf(s,Ue),jf(s,Ue),Xf(s,Ue,st.pos);for(let e=0;e<Gn.length;e++)Gn[e].popped||(Gn[e].group.position.y=Gn[e].floatY+Math.sin(Ue*.6+Gn[e].phase)*Gn[e].bobAmp);for(let e=0;e<gn.length;e++)for(let n=0;n<gn[e].pads.length;n++)gn[e].pads[n].mesh.position.y=.05+Math.sin(Ue*.8+gn[e].pads[n].phase)*.015;for(let e=0;e<_n.length;e++){const n=_n[e],i=Math.sin(Ue*1.5+n.phase)*.5+.5;n.group.position.y=n.flyY+Math.sin(Ue*.8+n.phase)*.3,n.glowMat.opacity=.3+i*.4}yu();return}Gv(s),ay(s,Ue),Vf(s,Ue),SM(s),Ke.position.copy(st.pos),Ke.position.y+=Ff,Ke.rotation.order="YXZ",Ke.rotation.y=Eo,Ke.rotation.x=Yi,KM(s,st.pos),yu()}try{hl(0,0,5),Ov(),OM({scene:vt,moon:Tn,moon2:An,hemiLight:ql,playerLight:Zl}),ty(),Nv(),Bv(me,Jr),kv(AM),VM(),XM(),vM(150),yM(60),Tv(),bM(lv),TM(20),Kv(40),PM(30),pM(),_M(),xM(),$M(),JM(),DM({orbs:_n,obeliskGroup:uM(),obeliskMat:fM(),obeliskGlowMat:dM(),moatMesh:mM(),moatMat:gM(),rainbowArcs:ml,player:st,makeLaser:NM,orbHudEl:jM(),deers:Ao,puffs:ei,jellies:To,moths:Co}),Av(cy);for(let s=0;s<50;s++){const t=Math.random()*6.28,e=3+Math.random()*le*.7,n=Math.cos(t)*e,i=Math.sin(t)*e;gl(n,ie(n,i),i,8+Math.random()*12)}console.log("✓ Init: trees="+me.length+" mush="+ln.length+" crystals="+re.length+" orbs="+_n.length+" creatures="+(To.length+ei.length+Ao.length+Co.length)+" wisps="+jr.length+" dandelions="+th.length+" fairyRings="+Qr.length+" bubbles="+Gn.length+" ponds="+gn.length+" scene="+vt.children.length),id()}catch(s){console.error("INIT FAILED:",s),document.body.innerHTML='<div style="color:red;padding:30px;font-family:monospace"><h2>Init Failed</h2><pre>'+(s.stack||s.message)+"</pre></div>"}
