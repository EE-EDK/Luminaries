...
`)+`
`+p);const x=y+d+r,_=y+p+a,A=lu(i,i.VERTEX_SHADER,x),E=lu(i,i.FRAGMENT_SHADER,_);i.attachShader(v,A),i.attachShader(v,E),e.index0AttributeName!==void 0?i.bindAttribLocation(v,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(v,0,"position"),i.linkProgram(v);function b(P){if(s.debug.checkShaderErrors){const N=i.getProgramInfoLog(v).trim(),D=i.getShaderInfoLog(A).trim(),O=i.getShaderInfoLog(E).trim();let W=!0,H=!0;if(i.getProgramParameter(v,i.LINK_STATUS)===!1)if(W=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,v,A,E);else{const Z=uu(i,A,"vertex"),X=uu(i,E,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(v,i.VALIDATE_STATUS)+`
