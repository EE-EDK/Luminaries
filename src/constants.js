...
export const GRASS_PATCHES = 1440; // +20% safe increase (GPU-driven)
export const FERN_N = 250;         // +90 mixed plant density pass
export const FLOWER_N = 230;       // +90 mixed plant density pass
export const REED_N = 90;          // +50 mixed plant density pass
...
export const DANDELION_N = 60;     // +35 mixed plant density pass
export const FAIRY_RING_N = 8;
export const BUBBLE_N = 40;
export const STARMOTE_N = 50;
export const POND_N = 10;
export const THORNBLOOM_N = 55;    // +25 mixed plant density pass
export const HELIXVINE_N = 50;     // +20 mixed plant density pass
export const SNAPTHORN_N = 44;     // +20 mixed plant density pass
export const SPIRALFROND_N = 65;   // +20 mixed plant density pass
export const CORPSEBLOOM_N = 34;   // +10 mixed plant density pass
export const ORBBUSH_N = 46;       // +10 mixed plant density pass
export const LANTERNPOD_N = 41;    // +5 mixed plant density pass
export const VEILMOSS_N = 50;      // +5 mixed plant density pass
...
export const C = {
  ...
  puffCottageBrick: 0x9a6a44, puffCottageCap: 0xf08090, puffCottageSpot: 0xfff4ec,
  // Local emissive for the finale cottage — lighter rose-pink cap reads bright & cheerful
  // against the cyan finale world. Softer rose glow (not deep red) matches the lighter cap.
  puffCottageCapEmissive: 0xd06070, puffCottageSpotEmissive: 0xffe8d8,
