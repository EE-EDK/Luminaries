...
const KF = [
  { // DUSK (0.0) — twilight, warm low moon, glow awakening
    label: 'DUSK',
    sky: new THREE.Color(0x0c1420),
    fog: new THREE.Color(0x0a1018),
    fogDensity: 0.012,
    moonInt: 0.5,
    moonCol: new THREE.Color(0xddaa88),
    moonElev: 15,
    ambSky: new THREE.Color(0x332244),
    ambGnd: new THREE.Color(0x181810),
    ambInt: 0.4,
    stars: 0.4,
    bio: 0.7,
    plRange: 15,
  ...
  { // NIGHT (0.25) — standard night, matches current baseline exactly
    label: 'NIGHT',
    sky: new THREE.Color(0x030610),
    fog: new THREE.Color(0x060c14),
    fogDensity: 0.014,
    moonInt: 0.85,
    moonCol: new THREE.Color(0xbbccee),
    moonElev: 55,
    ambSky: new THREE.Color(0x223355),
    ambGnd: new THREE.Color(0x102818),
    ambInt: 0.5,
    stars: 0.85,
    bio: 1.0,
    plRange: 18,
  ...
  { // DEEP NIGHT (0.5) — darkest, bioluminescence peaks, stars brightest
    label: 'DEEP_NIGHT',
    sky: new THREE.Color(0x020408),
    fog: new THREE.Color(0x040810),
    fogDensity: 0.018,
    moonInt: 0.3,
    moonCol: new THREE.Color(0x8899bb),
    moonElev: 75,
    ambSky: new THREE.Color(0x111833),
    ambGnd: new THREE.Color(0x0a1410),
    ambInt: 0.3,
    stars: 1.0,
    bio: 1.4,
    plRange: 22,
  ...
  { // DAWN (0.75) — misty, fading glow, warm setting moon
    ...
    fog: new THREE.Color(0x0c1020),
    fogDensity: 0.016,
    moonInt: 0.4,
    moonCol: new THREE.Color(0xccbbaa),
    moonElev: 20,
    ambSky: new THREE.Color(0x2a2244),
    ambGnd: new THREE.Color(0x141812),
    ambInt: 0.45,
    stars: 0.35,
    bio: 0.65,
    plRange: 16,
